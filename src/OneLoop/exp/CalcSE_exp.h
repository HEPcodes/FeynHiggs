...
* please do not edit directly
	...
	subroutine CalcSE_exp(onshell, key, dkey)
	implicit none
...
#include "looptools.h"
	...
	call dZ_h0h0_exp(dZh0h0)

	call dZ_HHHH_exp(dZHHHH)

	call se_ZZ_exp(seZZ,MZ2)
	...
	call se_A0A0_exp(seA0A0,MA02)

	dMsq1_(A0A0) = Re(seA0A0)

	else

	call se_HmHp_exp(seHmHp,MHp2)

	call se_WW_exp(seWW,MW2)
