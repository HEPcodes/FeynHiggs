...
\ROUTINE{FHGetSelf, FHGetSelfgl}

\DESCRIPTION

\CODE{FHGetSelf} returns the renormalized Higgs self-energies at a given
$k^2$.  \CODE{FHGetSelfgl} does the same but with results in the
gaugeless limit.  The flags and parameters must have been set before
