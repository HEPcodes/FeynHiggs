...
\chapter*{FeynHiggs 2.13.0\\[2ex] Application Programming Interface}
...
\item[3:] the cMSSM $\alpha_s\alpha_t$ and $\alpha_t^2$ corrections are 
  combined with the remaining corrections, whose complex phases are 
  interpolated in $A_t$, $A_b$, $M_3$, $\mu$,
