...
lambda*lambda)*pow(y[5]+y[7]+y[10],2)*y[4]*y[6]*y[15]*y[16]+(1.-lambda*MYI*\
x0*y[4]*y[6]*(y[5]+y[8])+lambda*MYI*x0*y[6]*y[13]-lambda*MYI*y[4]*y[6]*y[13\
])*(1.+lambda*MYI*x1*y[16]*y[21]-lambda*MYI*y[15]*y[16]*y[21]));
return (FOUT);
}
