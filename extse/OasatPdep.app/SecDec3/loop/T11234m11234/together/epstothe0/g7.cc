...
*y[35]*y[49]*y[50]*y[65]*y[66]*y[67]+x1*y[1]*y[6]*y[33]*y[35]*y[49]*y[50]*y\
...
]*y[64]*y[65]*y[66]*y[67]+x2*y[1]*y[6]*y[33]*y[52]*y[63]*y[64]*y[65]*y[66]*\
...
[2]*y[3]*y[35]*y[49]*y[50]-x0*x1*x2*y[1]*y[4]*y[35]*y[49]*y[50]-x0*x1*y[1]*\
y[6]*y[35]*y[49]*y[50]-x1*y[1]*y[7]*y[35]*y[49]*y[50]-x0*x1*y[1]*y[7]*y[35]\
...
33]*y[35]*y[49]*y[50]-x1*y[1]*y[6]*y[33]*y[35]*y[49]*y[50]+x1*x2*y[1]*y[8]*\
...
5]*y[52]*y[63]*y[64]-x0*x2*y[1]*y[6]*y[52]*y[63]*y[64]-x2*y[1]*y[7]*y[52]*y\
...
*y[63]*y[64]-x2*y[1]*y[6]*y[33]*y[52]*y[63]*y[64]+x1*x2*y[1]*y[8]*y[33]*y[5\
2]*y[63]*y[64]);
return (FOUT);
}
...
[49]*y[50]-x0*x1*y[1]*y[6]*y[35]*y[49]*y[50]-x1*y[1]*y[7]*y[35]*y[49]*y[50]\
...
50]-x1*x2*y[1]*y[4]*y[33]*y[35]*y[49]*y[50]-x1*y[1]*y[6]*y[33]*y[35]*y[49]*\
...
64]-2.*x0*y[1]*y[4]*y[5]*y[52]*y[63]*y[64]-x0*x2*y[1]*y[6]*y[52]*y[63]*y[64\
]-x2*y[1]*y[7]*y[52]*y[63]*y[64]-x0*x2*y[1]*y[7]*y[52]*y[63]*y[64]+x0*x2*y[\
...
*y[4]*y[5]*y[33]*y[52]*y[63]*y[64]-x2*y[1]*y[6]*y[33]*y[52]*y[63]*y[64]+x1*\
...
66]*y[67]+x1*y[1]*y[6]*y[33]*y[35]*y[49]*y[50]*y[65]*y[66]*y[67]-x1*x2*y[1]\
...
2*y[1]*y[6]*y[33]*y[52]*y[63]*y[64]*y[65]*y[66]*y[67]-x1*x2*y[1]*y[8]*y[33]\
...
3]+x1*y[1]*y[6]*y[33]+x2*y[1]*y[6]*y[33]-x1*x2*y[1]*y[8]*y[33]+y[41]+y[43]+\
...
1*y[1]*y[6]*y[10]*y[31]*y[32]*y[33]*y[35]*y[49]*y[50]+2.*x1*x2*y[1]*y[8]*y[\
...
y[4]*y[5]*y[10]*y[31]*y[32]*y[33]*y[52]*y[63]*y[64]-2.*x2*y[1]*y[6]*y[10]*y\
...
*y[50]-x0*x1*y[1]*y[6]*y[35]*y[49]*y[50]-x1*y[1]*y[7]*y[35]*y[49]*y[50]-x0*\
...
x1*x2*y[1]*y[4]*y[33]*y[35]*y[49]*y[50]-x1*y[1]*y[6]*y[33]*y[35]*y[49]*y[50\
...
2.*x0*y[1]*y[4]*y[5]*y[52]*y[63]*y[64]-x0*x2*y[1]*y[6]*y[52]*y[63]*y[64]-x2\
*y[1]*y[7]*y[52]*y[63]*y[64]-x0*x2*y[1]*y[7]*y[52]*y[63]*y[64]+x0*x2*y[1]*y\
...
]*y[5]*y[33]*y[52]*y[63]*y[64]-x2*y[1]*y[6]*y[33]*y[52]*y[63]*y[64]+x1*x2*y\
...
y[67]+x1*y[1]*y[6]*y[33]*y[35]*y[49]*y[50]*y[65]*y[66]*y[67]-x1*x2*y[1]*y[8\
...
1]*y[6]*y[33]*y[52]*y[63]*y[64]*y[65]*y[66]*y[67]-x1*x2*y[1]*y[8]*y[33]*y[5\
...
-x1*x2*y[1]*y[4]*y[33]*y[35]*y[49]*y[50]-x1*y[1]*y[6]*y[33]*y[35]*y[49]*y[5\
0]+x1*x2*y[1]*y[8]*y[33]*y[35]*y[49]*y[50]-x0*x1*x2*y[1]*y[2]*y[52]*y[63]*y\
[64]-x0*x2*y[1]*y[4]*y[52]*y[63]*y[64]-x0*x1*x2*y[1]*y[4]*y[52]*y[63]*y[64]\
-2.*x0*y[1]*y[4]*y[5]*y[52]*y[63]*y[64]-x0*x2*y[1]*y[6]*y[52]*y[63]*y[64]-x\
2*y[1]*y[7]*y[52]*y[63]*y[64]-x0*x2*y[1]*y[7]*y[52]*y[63]*y[64]+x0*x2*y[1]*\
...
4]*y[5]*y[33]*y[52]*y[63]*y[64]-x2*y[1]*y[6]*y[33]*y[52]*y[63]*y[64]+x1*x2*\
...
*y[67]+x1*y[1]*y[6]*y[33]*y[35]*y[49]*y[50]*y[65]*y[66]*y[67]-x1*x2*y[1]*y[\
...
[66]*y[67]+2.*y[1]*y[4]*y[5]*y[33]*y[52]*y[63]*y[64]*y[65]*y[66]*y[67]+x2*y\
[1]*y[6]*y[33]*y[52]*y[63]*y[64]*y[65]*y[66]*y[67]-x1*x2*y[1]*y[8]*y[33]*y[\
...
]*y[6]+x2*y[1]*y[6]+2.*x0*x2*y[1]*y[6]+x1*y[1]*y[7]+x2*y[1]*y[7]-x2*y[1]*y[\
...
y[2]*y[3]+x2*y[1]*y[2]*y[3]+x0*x2*y[1]*y[4]+x2*y[1]*y[3]*y[4]+x0*y[1]*y[5]+\
y[1]*y[3]*y[5]+y[1]*y[6]+x0*y[1]*y[6]-x0*x2*y[1]*y[7]-x2*y[1]*y[3]*y[7]);
return (FOUT);
}
...
y[3]+x1*y[1]*y[2]*y[4]+x1*y[1]*y[3]*y[4]+2.*x2*y[1]*y[3]*y[4]+x0*y[1]*y[5]+\
y[1]*y[4]*y[5]+y[1]*y[6]+x0*y[1]*y[6]-x0*y[1]*y[7]-x0*x1*y[1]*y[7]-x1*y[1]*\
y[4]*y[7]);
return (FOUT);
}
