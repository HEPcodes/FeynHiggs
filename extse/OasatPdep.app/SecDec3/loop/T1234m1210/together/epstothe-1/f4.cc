...
lambda*lambda)*pow(y[7]+y[8]+y[9]+y[11],2)*y[4]*y[5]*y[18]*y[19]+(1.-lambda\
*MYI*x0*(2.*y[1]*y[2]+2.*x1*y[1]*y[2])*y[4]*y[5]+lambda*MYI*x0*y[5]*y[16]-l\
ambda*MYI*y[4]*y[5]*y[16])*(1.+lambda*MYI*x1*y[19]*y[25]-lambda*MYI*y[18]*y\
[19]*y[25]));
return (FOUT);
}
