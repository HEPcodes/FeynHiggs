...
y[35]=y[6]+y[20]+y[22]+y[23]+y[24]+y[25]+y[26]+y[27]+y[28]+y[29]+y[30]+y[31]\
+y[32]+y[33]+y[34];
y[36]=lrs[1];
y[37]=-x2;
y[38]=1.+y[37];
...
y[41]=y[6]+y[7]+y[9]+y[20]+y[22]+y[39]+y[40];
y[42]=lambda*lambda;
y[43]=y[1]*y[2];
y[44]=2.*x1*y[1]*y[2];
...
y[51]=y[6]+y[7]+y[9]+y[43]+y[44]+y[45]+y[46]+y[47]+y[48]+y[49]+y[50];
...
y[58]=-(x0*x2*y[1]*y[4]);
y[59]=-(x2*y[1]*y[3]*y[4]);
y[60]=y[9]+y[12]+y[14]+y[39]+y[52]+y[53]+y[54]+y[55]+y[56]+y[57]+y[58]+y[59]\
;
y[61]=lrs[2];
y[62]=2.*y[1]*y[2]*y[21];
...
y[81]=-(x0*x1*y[1]*y[4]);
y[82]=-(x1*y[1]*y[3]*y[4]);
y[83]=y[9]+y[55]+y[56]+y[57]+y[79]+y[80]+y[81]+y[82];
