...
y[47]=y[5]*y[38]*y[39];
y[48]=x0*x1*y[5]*y[38];
y[49]=x1*y[5]*y[38]*y[39];
y[50]=-(x0*x1*y[5]*y[9]);
y[51]=lrs[2];
y[52]=-x2;
y[53]=1.+y[52];
y[54]=x2*x2;
y[55]=2.*x0*x2*y[5]*y[37];
y[56]=2.*x2*y[5]*y[38]*y[39];
y[57]=-(x0*y[5]*y[9]);
y[58]=y[15]+y[42]+y[43]+y[46]+y[47]+y[55]+y[56]+y[57];
y[59]=x2*y[5]*y[37];
y[60]=x2*y[5]*y[38];
y[61]=2.*x0*x2*y[5]*y[38];
y[62]=x1*x2*y[4]*y[5];
y[63]=x1*x2*y[5]*y[37];
y[64]=x1*y[5]*y[37]*y[54];
y[65]=x1*x2*y[5]*y[38];
y[66]=2.*x0*x1*x2*y[5]*y[38];
y[67]=2.*x0*x1*y[5]*y[38]*y[54];
y[68]=-(x1*x2*y[5]*y[9]);
y[69]=y[7]+y[8]+y[10]+y[59]+y[60]+y[61]+y[62]+y[63]+y[64]+y[65]+y[66]+y[67]+\
y[68];
y[70]=2.*x1*x2*y[5]*y[37];
y[71]=y[5]*y[38];
y[72]=2.*x0*y[5]*y[38];
y[73]=x1*y[5]*y[38];
y[74]=2.*x0*x1*y[5]*y[38];
y[75]=4.*x0*x1*x2*y[5]*y[38];
y[76]=-(x1*y[5]*y[9]);
y[77]=y[8]+y[42]+y[44]+y[70]+y[71]+y[72]+y[73]+y[74]+y[75]+y[76];
y[78]=x2*y[4]*y[5];
y[79]=y[5]*y[37]*y[54];
y[80]=2.*x0*y[5]*y[38]*y[54];
y[81]=-(x2*y[5]*y[9]);
y[82]=y[7]+y[59]+y[60]+y[61]+y[78]+y[79]+y[80]+y[81];
y[83]=x0*x2*y[4]*y[5];
y[84]=x0*x2*y[5]*y[37];
y[85]=x0*y[5]*y[37]*y[54];
y[86]=x0*x2*y[5]*y[38];
y[87]=x2*y[5]*y[38]*y[39];
y[88]=y[5]*y[38]*y[39]*y[54];
y[89]=-(x0*x2*y[5]*y[9]);
y[90]=y[7]+y[15]+y[59]+y[83]+y[84]+y[85]+y[86]+y[87]+y[88]+y[89];
y[91]=2.*x2*y[5]*y[38];
y[92]=2.*x1*x2*y[5]*y[38];
y[93]=2.*x1*y[5]*y[38]*y[54];
y[94]=y[91]+y[92]+y[93];
...
y[101]=1.+y[99]+y[100];
y[102]=2.*x0*x1*x2*y[5]*y[37];
y[103]=2.*x1*x2*y[5]*y[38]*y[39];
...
y[6]*y[13]*y[14]*y[21]+y[98]*y[101])*(1.-lambda*MYI*x2*(2.*x0*x1*y[5]*y[37]\
+2.*x1*y[5]*y[38]*y[39])*y[51]*y[53]+lambda*MYI*x2*y[51]*y[104]+y[105])))/(\
1.+y[105]);
return (FOUT);
}
