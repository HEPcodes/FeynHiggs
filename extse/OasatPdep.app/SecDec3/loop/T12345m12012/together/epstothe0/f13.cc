...
y[36]=2.*x1*x2*x3*y[1]*y[2];
y[37]=x1*y[1]*y[2]*y[23];
y[38]=2.*x0*x2*y[1]*y[2]*y[23];
y[39]=x1*x2*y[1]*y[4];
y[40]=x1*x3*y[1]*y[4];
y[41]=x2*x3*y[1]*y[4];
y[42]=2.*x0*x2*x3*y[1]*y[4];
y[43]=-(x1*x2*y[1]*y[5]);
y[44]=-(x1*x3*y[1]*y[5]);
y[45]=-(x2*x3*y[1]*y[5]);
y[46]=-2.*x0*x2*x3*y[1]*y[5];
y[47]=y[10]+y[25]+y[26]+y[27]+y[28]+y[29]+y[30]+y[31]+y[32]+y[33]+y[34]+y[35\
...
y[56]=y[10]+y[12]+y[13]+y[14]+y[22]+y[25]+y[26]+y[30]+y[31];
y[57]=2.*x1*x2*y[1]*y[2];
y[58]=2.*x3*y[1]*y[2];
y[59]=4.*x0*x2*x3*y[1]*y[2];
y[60]=-2.*x0*x2*y[1]*y[5];
y[61]=y[9]+y[10]+y[11]+y[12]+y[13]+y[14]+y[18]+y[27]+y[29]+y[51]+y[52]+y[53]\
+y[57]+y[58]+y[59]+y[60];
y[62]=x0*x2*y[1]*y[2];
y[63]=x0*x3*y[1]*y[2];
y[64]=x0*y[1]*y[2]*y[23];
y[65]=x0*x2*y[1]*y[4];
y[66]=x0*x3*y[1]*y[4];
y[67]=-(x0*x2*y[1]*y[5]);
y[68]=-(x0*x3*y[1]*y[5]);
y[69]=y[7]+y[9]+y[10]+y[11]+y[12]+y[13]+y[14]+y[17]+y[25]+y[30]+y[31]+y[35]+\
y[52]+y[57]+y[62]+y[63]+y[64]+y[65]+y[66]+y[67]+y[68];
y[70]=lrs[2];
y[71]=y[1]*y[2]*y[3];
y[72]=2.*x0*x1*y[1]*y[2];
y[73]=2.*x3*y[1]*y[2]*y[3];
y[74]=y[1]*y[3]*y[4];
y[75]=-(y[1]*y[3]*y[5]);
y[76]=y[6]+y[7]+y[8]+y[71]+y[72]+y[73]+y[74]+y[75];
y[77]=2.*x2*y[1]*y[2]*y[23];
y[78]=2.*x2*x3*y[1]*y[4];
y[79]=-2.*x2*x3*y[1]*y[5];
y[80]=y[22]+y[28]+y[77]+y[78]+y[79];
...
y[92]=-x3;
y[93]=1.+y[92];
y[94]=2.*x0*y[1]*y[2]*y[23];
y[95]=2.*y[1]*y[4];
y[96]=2.*x0*y[1]*y[4];
y[97]=2.*x0*x3*y[1]*y[4];
y[98]=-2.*x0*x3*y[1]*y[5];
y[99]=y[19]+y[25]+y[27]+y[30]+y[31]+y[51]+y[52]+y[53]+y[94]+y[95]+y[96]+y[97\
]+y[98];
...
y[105]=x1*x1;
y[106]=y[1]*y[2]*y[105];
y[107]=x3*y[1]*y[2]*y[3];
y[108]=2.*x0*x1*x3*y[1]*y[2];
y[109]=y[1]*y[2]*y[3]*y[23];
y[110]=x0*x1*y[1]*y[4];
y[111]=x3*y[1]*y[3]*y[4];
y[112]=-(x0*x1*y[1]*y[5]);
y[113]=-(x3*y[1]*y[3]*y[5]);
y[114]=y[10]+y[27]+y[51]+y[53]+y[63]+y[66]+y[68]+y[74]+y[96]+y[104]+y[106]+y\
[107]+y[108]+y[109]+y[110]+y[111]+y[112]+y[113];
y[115]=lrs[3];
...
y[136]=2.*x0*x1*x2*y[1]*y[2];
y[137]=2.*x2*x3*y[1]*y[2]*y[3];
y[138]=x2*y[1]*y[3]*y[4];
y[139]=-(x2*y[1]*y[3]*y[5]);
y[140]=y[6]+y[7]+y[8]+y[10]+y[19]+y[27]+y[51]+y[53]+y[62]+y[65]+y[67]+y[104]\
...
4])*(1.-lambda*MYI*x3*(2.*x0*y[1]*y[2]+2.*x2*y[1]*y[2]*y[3]+y[72])*y[93]*y[\
...
1]*y[142]*y[148]+y[1]*y[142]*y[146]*y[148])*(y[10]+y[1]*y[4]*y[142]+y[1]*y[\
2]*y[144]+y[1]*y[4]*y[144]-y[1]*y[5]*y[144]+y[1]*y[2]*y[142]*y[144]+y[1]*y[\
4]*y[142]*y[144]-y[1]*y[5]*y[142]*y[144]+y[1]*y[4]*y[146]+y[1]*y[2]*y[144]*\
y[146]+y[1]*y[4]*y[144]*y[146]-y[1]*y[5]*y[144]*y[146]+y[1]*y[4]*y[148]+2.*\
y[1]*y[4]*y[142]*y[148]+y[1]*y[4]*y[144]*y[148]+y[1]*y[2]*y[142]*y[144]*y[1\
48]+y[1]*y[4]*y[142]*y[144]*y[148]-y[1]*y[5]*y[142]*y[144]*y[148]+y[1]*y[2]\
*y[146]*y[148]+y[1]*y[4]*y[146]*y[148]-y[1]*y[5]*y[146]*y[148]+y[1]*y[2]*y[\
142]*y[146]*y[148]+y[1]*y[4]*y[142]*y[146]*y[148]-y[1]*y[5]*y[142]*y[146]*y\
[148]+y[1]*y[2]*y[144]*y[146]*y[148]+y[1]*y[4]*y[144]*y[146]*y[148]-y[1]*y[\
5]*y[144]*y[146]*y[148]+2.*y[1]*y[2]*y[142]*y[144]*y[146]*y[148]+y[1]*y[2]*\
y[149]+y[1]*y[2]*y[142]*y[149]+y[1]*y[2]*y[146]*y[149]+y[1]*y[4]*y[142]*y[1\
50]+y[1]*y[2]*y[142]*y[146]*y[150]+y[1]*y[4]*y[142]*y[146]*y[150]-y[1]*y[5]\
*y[142]*y[146]*y[150]+y[1]*y[2]*y[148]*y[151]+y[1]*y[2]*y[144]*y[148]*y[151\
]+y[1]*y[2]*y[142]*y[150]*y[151]));
return (FOUT);
}
