...
y[77]=2.*x0*x1*y[1]*y[4];
y[78]=x0*x2*y[1]*y[4];
y[79]=2.*x1*x2*y[1]*y[2]*y[4];
y[80]=x0*x2*y[1]*y[7];
y[81]=-(x0*x2*y[1]*y[5]);
y[82]=-(x2*y[1]*y[2]*y[5]);
y[83]=y[11]+y[15]+y[16]+y[17]+y[68]+y[72]+y[73]+y[74]+y[75]+y[76]+y[77]+y[78\
]+y[79]+y[80]+y[81]+y[82];
y[84]=lrs[2];
y[85]=2.*x1*y[1]*y[6];
...
y[109]=x0*x1*y[1]*y[4];
y[110]=y[1]*y[2]*y[4]*y[24];
y[111]=x0*x1*y[1]*y[7];
y[112]=-(x0*x1*y[1]*y[5]);
y[113]=-(x1*y[1]*y[2]*y[5]);
y[114]=y[12]+y[18]+y[61]+y[68]+y[72]+y[105]+y[106]+y[107]+y[108]+y[109]+y[11\
0]+y[111]+y[112]+y[113];
