...
y[66]=y[39]+y[47]+y[50]+y[56]+y[57]+y[58]+y[59]+y[60]+y[61]+y[62]+y[63]+y[64\
]+y[65];
y[67]=lrs[2];
y[68]=pow(y[10],2);
y[69]=pow(y[31],2);
...
+x0*x1*x2*y[1]*y[7]*y[10]*y[31]*y[32]*y[35]*y[52]*y[53]*y[55]*y[66]*y[67]+2\
...
*y[66]*y[67]+4.*x2*y[1]*y[5]*y[6]*y[10]*y[31]*y[32]*y[33]*y[35]*y[52]*y[53]\
...
[52]*y[53]*y[68]*y[69]*y[70]+2.*y[1]*y[5]*y[6]*y[33]*y[35]*y[52]*y[53]*y[68\
]*y[69]*y[70]+2.*x2*y[1]*y[5]*y[6]*y[33]*y[35]*y[52]*y[53]*y[68]*y[69]*y[70\
...
]*y[69]*y[70]+x2*y[1]*y[5]*y[6]*y[33]*y[55]*y[66]*y[67]*y[68]*y[69]*y[70]-x\
1*x2*y[1]*y[8]*y[33]*y[55]*y[66]*y[67]*y[68]*y[69]*y[70]+x0*y[1]*y[5]*y[6]*\
y[10]*y[31]*y[32]*y[71]*y[72]*y[73]+2.*y[1]*y[5]*y[6]*y[10]*y[31]*y[32]*y[3\
3]*y[71]*y[72]*y[73]+2.*x2*y[1]*y[5]*y[6]*y[10]*y[31]*y[32]*y[33]*y[71]*y[7\
2]*y[73]+x2*y[1]*y[5]*y[6]*y[33]*y[55]*y[66]*y[67]*y[71]*y[72]*y[73]+x0*y[1\
...
2]-x0*y[1]*y[5]*y[6]*y[10]*y[31]*y[32]-x0*x1*y[1]*y[7]*y[10]*y[31]*y[32]-x0\
...
]*y[4]*y[35]*y[52]*y[53]-x0*x1*y[1]*y[5]*y[35]*y[52]*y[53]-x0*x1*x2*y[1]*y[\
...
5]*y[52]*y[53]-x1*x2*y[1]*y[4]*y[33]*y[35]*y[52]*y[53]-2.*y[1]*y[5]*y[6]*y[\
33]*y[35]*y[52]*y[53]-2.*x2*y[1]*y[5]*y[6]*y[33]*y[35]*y[52]*y[53]+x1*x2*y[\
...
1]*y[4]*y[55]*y[66]*y[67]-x0*x1*x2*y[1]*y[5]*y[55]*y[66]*y[67]-x2*y[1]*y[7]\
*y[55]*y[66]*y[67]-x0*x1*x2*y[1]*y[7]*y[55]*y[66]*y[67]+x0*x2*y[1]*y[8]*y[5\
...
5]*y[6]*y[33]*y[55]*y[66]*y[67]+x1*x2*y[1]*y[8]*y[33]*y[55]*y[66]*y[67]);
return (FOUT);
}
...
y[45]=x2*y[1]*y[3]*y[5];
y[46]=x0*y[1]*y[6];
y[47]=2.*x0*x1*y[1]*y[6];
y[48]=2.*x1*y[1]*y[3]*y[6];
y[49]=x0*x2*y[1]*y[6];
y[50]=2.*x1*x2*y[1]*y[3]*y[6];
y[51]=x0*y[1]*y[8];
y[52]=x0*x2*y[1]*y[8];
y[53]=-(x0*y[1]*y[9]);
y[54]=-(x2*y[1]*y[3]*y[9]);
...
7]*y[13]*y[34]*y[36]-x2*y[1]*y[3]*y[6]*y[7]*y[13]*y[34]*y[36]+x1*x2*y[1]*y[\
...
[33]*y[35]*y[41]*y[55]*y[56]-2.*x0*y[1]*y[6]*y[7]*y[12]*y[33]*y[35]*y[41]*y\
[55]*y[56]-4.*y[1]*y[3]*y[6]*y[7]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]-4.*x2\
*y[1]*y[3]*y[6]*y[7]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]-x0*x1*y[1]*y[8]*y[\
12]*y[33]*y[35]*y[41]*y[55]*y[56]-x0*x1*x2*y[1]*y[8]*y[12]*y[33]*y[35]*y[41\
]*y[55]*y[56]+x0*x1*y[1]*y[9]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]+2.*x1*x2*\
y[1]*y[3]*y[9]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]-x0*y[1]*y[6]*y[7]*y[57]*\
y[58]*y[59]-y[1]*y[3]*y[6]*y[7]*y[57]*y[58]*y[59]-x2*y[1]*y[3]*y[6]*y[7]*y[\
...
*y[65]*y[72]*y[73]-2.*x2*y[1]*y[3]*y[6]*y[7]*y[12]*y[33]*y[35]*y[65]*y[72]*\
y[73]-x0*x1*x2*y[1]*y[8]*y[12]*y[33]*y[35]*y[65]*y[72]*y[73]+x0*x2*y[1]*y[9\
...
2]*y[73]-2.*x2*y[1]*y[3]*y[6]*y[7]*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]-x0*x\
1*x2*y[1]*y[8]*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]+x1*x2*y[1]*y[3]*y[9]*y[4\
1]*y[55]*y[56]*y[65]*y[72]*y[73]-x0*y[1]*y[2]*y[4]*y[74]*y[75]*y[76]-x1*y[1\
]*y[2]*y[3]*y[4]*y[74]*y[75]*y[76])+pow(lambda,4)*(y[1]*y[3]*y[6]*y[7]*y[13\
]*y[34]*y[36]*y[57]*y[58]*y[59]+x2*y[1]*y[3]*y[6]*y[7]*y[13]*y[34]*y[36]*y[\
...
6]*y[65]*y[72]*y[73]+2.*x2*y[1]*y[3]*y[6]*y[7]*y[13]*y[34]*y[36]*y[41]*y[55\
]*y[56]*y[65]*y[72]*y[73]-x1*x2*y[1]*y[3]*y[9]*y[13]*y[34]*y[36]*y[41]*y[55\
]*y[56]*y[65]*y[72]*y[73]+2.*x2*y[1]*y[3]*y[6]*y[7]*y[12]*y[33]*y[35]*y[57]\
...
]*y[3]*y[6]*y[7]*y[12]*y[33]*y[35]-2.*x2*y[1]*y[3]*y[6]*y[7]*y[12]*y[33]*y[\
35]-x0*x1*y[1]*y[8]*y[12]*y[33]*y[35]-x0*x1*x2*y[1]*y[8]*y[12]*y[33]*y[35]+\
...
x2*y[1]*y[3]*y[5]*y[41]*y[55]*y[56]-x0*x1*y[1]*y[6]*y[41]*y[55]*y[56]-x0*x1\
*x2*y[1]*y[6]*y[41]*y[55]*y[56]-2.*x0*y[1]*y[6]*y[7]*y[41]*y[55]*y[56]-2.*y\
[1]*y[3]*y[6]*y[7]*y[41]*y[55]*y[56]-2.*x2*y[1]*y[3]*y[6]*y[7]*y[41]*y[55]*\
y[56]-x1*y[1]*y[8]*y[41]*y[55]*y[56]-x0*x1*y[1]*y[8]*y[41]*y[55]*y[56]-x0*x\
1*x2*y[1]*y[8]*y[41]*y[55]*y[56]+x0*x1*y[1]*y[9]*y[41]*y[55]*y[56]+x1*x2*y[\
...
0*x2*y[1]*y[5]*y[65]*y[72]*y[73]-x1*x2*y[1]*y[3]*y[5]*y[65]*y[72]*y[73]-x0*\
x1*x2*y[1]*y[6]*y[65]*y[72]*y[73]-x2*y[1]*y[3]*y[6]*y[7]*y[65]*y[72]*y[73]-\
x2*y[1]*y[8]*y[65]*y[72]*y[73]-x0*x1*x2*y[1]*y[8]*y[65]*y[72]*y[73]+x0*x2*y\
...
5]*y[56]+2.*y[1]*y[3]*y[6]*y[7]*y[13]*y[34]*y[36]*y[41]*y[55]*y[56]+2.*x2*y\
[1]*y[3]*y[6]*y[7]*y[13]*y[34]*y[36]*y[41]*y[55]*y[56]-x1*x2*y[1]*y[3]*y[9]\
*y[13]*y[34]*y[36]*y[41]*y[55]*y[56]+x0*y[1]*y[6]*y[7]*y[12]*y[33]*y[35]*y[\
57]*y[58]*y[59]+2.*y[1]*y[3]*y[6]*y[7]*y[12]*y[33]*y[35]*y[57]*y[58]*y[59]+\
2.*x2*y[1]*y[3]*y[6]*y[7]*y[12]*y[33]*y[35]*y[57]*y[58]*y[59]+x1*x2*y[1]*y[\
...
*y[72]*y[73]+x2*y[1]*y[3]*y[6]*y[7]*y[13]*y[34]*y[36]*y[65]*y[72]*y[73]-x1*\
...
]*y[6]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]+4.*x2*y[1]*y[3\
]*y[6]*y[7]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]+x0*x1*x2*\
y[1]*y[8]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]-2.*x1*x2*y[\
1]*y[3]*y[9]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]+x2*y[1]*\
y[3]*y[6]*y[7]*y[57]*y[58]*y[59]*y[65]*y[72]*y[73]+x0*y[1]*y[2]*y[4]*y[12]*\
...
)+pow(lambda,5)*(-(x2*y[1]*y[3]*y[6]*y[7]*y[13]*y[34]*y[36]*y[57]*y[58]*y[5\
...
[33]-2.*x2*y[1]*y[5]*y[6]*y[10]*y[31]*y[32]*y[33]+2.*x1*x2*y[1]*y[8]*y[10]*\
y[31]*y[32]*y[33]-x0*x1*x2*y[1]*y[2]*y[35]*y[52]*y[53]-x0*x1*y[1]*y[4]*y[35\
]*y[52]*y[53]-x0*x1*y[1]*y[5]*y[35]*y[52]*y[53]-x0*x1*x2*y[1]*y[5]*y[35]*y[\
52]*y[53]-2.*x0*y[1]*y[5]*y[6]*y[35]*y[52]*y[53]-x1*y[1]*y[7]*y[35]*y[52]*y\
[53]-x0*x1*y[1]*y[7]*y[35]*y[52]*y[53]-x0*x1*x2*y[1]*y[7]*y[35]*y[52]*y[53]\
...
53]-x1*x2*y[1]*y[4]*y[33]*y[35]*y[52]*y[53]-2.*y[1]*y[5]*y[6]*y[33]*y[35]*y\
[52]*y[53]-2.*x2*y[1]*y[5]*y[6]*y[33]*y[35]*y[52]*y[53]+x1*x2*y[1]*y[8]*y[3\
...
5]*y[66]*y[67]-x0*x1*x2*y[1]*y[5]*y[55]*y[66]*y[67]-x2*y[1]*y[7]*y[55]*y[66\
]*y[67]-x0*x1*x2*y[1]*y[7]*y[55]*y[66]*y[67]+x0*x2*y[1]*y[8]*y[55]*y[66]*y[\
67]-x1*x2*y[1]*y[2]*y[33]*y[55]*y[66]*y[67]-2.*x1*y[1]*y[2]*y[3]*y[33]*y[55\
]*y[66]*y[67]-x1*x2*y[1]*y[4]*y[33]*y[55]*y[66]*y[67]-x2*y[1]*y[5]*y[6]*y[3\
...
*x1*x2*y[1]*y[7]*y[10]*y[31]*y[32]*y[35]*y[52]*y[53]*y[55]*y[66]*y[67]+2.*x\
...
66]*y[67]+4.*x2*y[1]*y[5]*y[6]*y[10]*y[31]*y[32]*y[33]*y[35]*y[52]*y[53]*y[\
...
]*y[53]*y[68]*y[69]*y[70]+2.*y[1]*y[5]*y[6]*y[33]*y[35]*y[52]*y[53]*y[68]*y\
[69]*y[70]+2.*x2*y[1]*y[5]*y[6]*y[33]*y[35]*y[52]*y[53]*y[68]*y[69]*y[70]-x\
...
[69]*y[70]+x2*y[1]*y[5]*y[6]*y[33]*y[55]*y[66]*y[67]*y[68]*y[69]*y[70]-x1*x\
2*y[1]*y[8]*y[33]*y[55]*y[66]*y[67]*y[68]*y[69]*y[70]+x0*y[1]*y[5]*y[6]*y[1\
0]*y[31]*y[32]*y[71]*y[72]*y[73]+2.*y[1]*y[5]*y[6]*y[10]*y[31]*y[32]*y[33]*\
y[71]*y[72]*y[73]+2.*x2*y[1]*y[5]*y[6]*y[10]*y[31]*y[32]*y[33]*y[71]*y[72]*\
y[73]+x2*y[1]*y[5]*y[6]*y[33]*y[55]*y[66]*y[67]*y[71]*y[72]*y[73]+x0*y[1]*y\
...
y[74]*y[75]*y[76])+pow(lambda,5)*(-(x2*y[1]*y[5]*y[6]*y[33]*y[55]*y[66]*y[6\
...
*y[55]*y[56]-x0*x1*y[1]*y[6]*y[41]*y[55]*y[56]-x0*x1*x2*y[1]*y[6]*y[41]*y[5\
5]*y[56]-2.*x0*y[1]*y[6]*y[7]*y[41]*y[55]*y[56]-2.*y[1]*y[3]*y[6]*y[7]*y[41\
]*y[55]*y[56]-2.*x2*y[1]*y[3]*y[6]*y[7]*y[41]*y[55]*y[56]-x1*y[1]*y[8]*y[41\
]*y[55]*y[56]-x0*x1*y[1]*y[8]*y[41]*y[55]*y[56]-x0*x1*x2*y[1]*y[8]*y[41]*y[\
...
72]*y[73]-x1*x2*y[1]*y[3]*y[5]*y[65]*y[72]*y[73]-x0*x1*x2*y[1]*y[6]*y[65]*y\
[72]*y[73]-x2*y[1]*y[3]*y[6]*y[7]*y[65]*y[72]*y[73]-x2*y[1]*y[8]*y[65]*y[72\
]*y[73]-x0*x1*x2*y[1]*y[8]*y[65]*y[72]*y[73]+x0*x2*y[1]*y[9]*y[65]*y[72]*y[\
...
[6]*y[7]*y[13]*y[34]*y[36]*y[41]*y[55]*y[56]+2.*x2*y[1]*y[3]*y[6]*y[7]*y[13\
]*y[34]*y[36]*y[41]*y[55]*y[56]-x1*x2*y[1]*y[3]*y[9]*y[13]*y[34]*y[36]*y[41\
]*y[55]*y[56]+x0*y[1]*y[6]*y[7]*y[12]*y[33]*y[35]*y[57]*y[58]*y[59]+2.*y[1]\
*y[3]*y[6]*y[7]*y[12]*y[33]*y[35]*y[57]*y[58]*y[59]+2.*x2*y[1]*y[3]*y[6]*y[\
7]*y[12]*y[33]*y[35]*y[57]*y[58]*y[59]+x1*x2*y[1]*y[2]*y[3]*y[13]*y[34]*y[3\
...
3]*y[6]*y[7]*y[13]*y[34]*y[36]*y[65]*y[72]*y[73]-x1*x2*y[1]*y[3]*y[9]*y[13]\
...
]*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]+4.*x2*y[1]*y[3]*y[6]*y[7]*y[12]*y[33]\
*y[35]*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]+x0*x1*x2*y[1]*y[8]*y[12]*y[33]*y\
[35]*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]-2.*x1*x2*y[1]*y[3]*y[9]*y[12]*y[33\
]*y[35]*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]+x2*y[1]*y[3]*y[6]*y[7]*y[57]*y[\
...
[1]*y[3]*y[6]*y[7]*y[13]*y[34]*y[36]*y[57]*y[58]*y[59]*y[65]*y[72]*y[73])-x\
...
1*x2*y[1]*y[6]+x0*y[1]*y[6]*y[7]+x2*y[1]*y[3]*y[6]*y[7]+x2*y[1]*y[8]+x0*x1*\
...
]*y[7]*y[13]*y[34]*y[36]-x2*y[1]*y[3]*y[6]*y[7]*y[13]*y[34]*y[36]+x1*x2*y[1\
...
2]*y[33]*y[35]*y[41]*y[55]*y[56]-2.*x0*y[1]*y[6]*y[7]*y[12]*y[33]*y[35]*y[4\
1]*y[55]*y[56]-4.*y[1]*y[3]*y[6]*y[7]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]-4\
.*x2*y[1]*y[3]*y[6]*y[7]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]-x0*x1*y[1]*y[8\
]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]-x0*x1*x2*y[1]*y[8]*y[12]*y[33]*y[35]*\
y[41]*y[55]*y[56]+x0*x1*y[1]*y[9]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]+2.*x1\
*x2*y[1]*y[3]*y[9]*y[12]*y[33]*y[35]*y[41]*y[55]*y[56]-x0*y[1]*y[6]*y[7]*y[\
57]*y[58]*y[59]-y[1]*y[3]*y[6]*y[7]*y[57]*y[58]*y[59]-x2*y[1]*y[3]*y[6]*y[7\
...
[35]*y[65]*y[72]*y[73]-2.*x2*y[1]*y[3]*y[6]*y[7]*y[12]*y[33]*y[35]*y[65]*y[\
72]*y[73]-x0*x1*x2*y[1]*y[8]*y[12]*y[33]*y[35]*y[65]*y[72]*y[73]+x0*x2*y[1]\
...
*y[72]*y[73]-2.*x2*y[1]*y[3]*y[6]*y[7]*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]-\
x0*x1*x2*y[1]*y[8]*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]+x1*x2*y[1]*y[3]*y[9]\
*y[41]*y[55]*y[56]*y[65]*y[72]*y[73]-x0*y[1]*y[2]*y[4]*y[74]*y[75]*y[76]-x1\
*y[1]*y[2]*y[3]*y[4]*y[74]*y[75]*y[76])+pow(lambda,4)*(y[1]*y[3]*y[6]*y[7]*\
y[13]*y[34]*y[36]*y[57]*y[58]*y[59]+x2*y[1]*y[3]*y[6]*y[7]*y[13]*y[34]*y[36\
...
*y[56]*y[65]*y[72]*y[73]+2.*x2*y[1]*y[3]*y[6]*y[7]*y[13]*y[34]*y[36]*y[41]*\
y[55]*y[56]*y[65]*y[72]*y[73]-x1*x2*y[1]*y[3]*y[9]*y[13]*y[34]*y[36]*y[41]*\
y[55]*y[56]*y[65]*y[72]*y[73]+2.*x2*y[1]*y[3]*y[6]*y[7]*y[12]*y[33]*y[35]*y\
...
*y[1]*y[4]+2.*x0*x1*x2*y[1]*y[4]+x1*y[1]*y[5]+x1*x2*y[1]*y[5]+y[1]*y[5]*y[6\
...
[1]*y[4]+y[1]*y[3]*y[4]+x2*y[1]*y[3]*y[4]+x0*y[1]*y[5]+2.*x0*x1*y[1]*y[5]+x\
0*x2*y[1]*y[5]+2.*x1*y[1]*y[3]*y[5]+2.*x1*x2*y[1]*y[3]*y[5]+y[1]*y[6]+x0*y[\
1]*y[6]+x0*x2*y[1]*y[6]-x0*y[1]*y[7]-x2*y[1]*y[3]*y[7]);
return (FOUT);
}
...
]*y[3]+2.*x1*x2*y[1]*y[2]*y[3]+x0*y[1]*y[4]+x1*y[1]*y[3]*y[4]+x0*x1*y[1]*y[\
5]+x1*x1*y[1]*y[3]*y[5]+y[1]*y[6]+x0*x1*y[1]*y[6]-x0*y[1]*y[7]-x1*y[1]*y[3]\
*y[7]);
return (FOUT);
}
