...
5]*y[19]*y[21]*y[30]*y[31]*y[32]*y[33]*y[34]+x0*y[1]*y[2]*y[5]*y[7]*y[17]*y\
...
[2]*y[5]*y[7]*y[17]*y[18]+x0*x1*y[1]*y[7]*y[15]*y[17]*y[18]-2.*x1*y[1]*y[4]\
*y[7]*y[17]*y[18]*y[19]-2.*y[1]*y[4]*y[5]*y[7]*y[17]*y[18]*y[19]-x1*y[1]*y[\
2]*y[21]*y[30]*y[31]-x0*x1*y[1]*y[2]*y[21]*y[30]*y[31]-x0*x1*y[1]*y[3]*y[21\
]*y[30]*y[31]-x0*x1*y[1]*y[4]*y[21]*y[30]*y[31]-2.*x0*y[1]*y[2]*y[5]*y[21]*\
...
0*y[1]*y[2]*y[6]+y[1]*y[4]*y[5]*y[6]+y[7]-x0*x1*y[1]*y[8]+y[9]+y[10]+pow(la\
...
y[1]*y[2]*y[6]*y[12]*y[20]*y[22]*y[25]*y[33]*y[34]-4.*y[1]*y[4]*y[5]*y[6]*y\
[12]*y[20]*y[22]*y[25]*y[33]*y[34]+x0*x1*y[1]*y[8]*y[12]*y[20]*y[22]*y[25]*\
y[33]*y[34]-x0*y[1]*y[2]*y[6]*y[35]*y[36]*y[37]-y[1]*y[4]*y[5]*y[6]*y[35]*y\
[36]*y[37]),2)+pow(lambda*(-(x0*x1*y[1]*y[2]*y[12]*y[20]*y[22])-x0*y[1]*y[3\
]*y[12]*y[20]*y[22]-x0*x1*y[1]*y[3]*y[12]*y[20]*y[22]-x0*x1*y[1]*y[4]*y[12]\
*y[20]*y[22]-2.*x1*y[1]*y[4]*y[5]*y[12]*y[20]*y[22]-x0*y[1]*y[2]*y[6]*y[12]\
...
[1]*y[4]*y[5]*y[25]*y[33]*y[34]-2.*x0*y[1]*y[2]*y[6]*y[25]*y[33]*y[34]-2.*y\
...
[4]*y[5]*y[6]*y[13]*y[21]*y[23]*y[25]*y[33]*y[34]+x0*y[1]*y[2]*y[6]*y[12]*y\
...
]*y[2]*y[5]*y[7]*y[17]*y[18]+x0*x1*y[1]*y[7]*y[15]*y[17]*y[18]-2.*x1*y[1]*y\
[4]*y[7]*y[17]*y[18]*y[19]-2.*y[1]*y[4]*y[5]*y[7]*y[17]*y[18]*y[19]-x1*y[1]\
*y[2]*y[21]*y[30]*y[31]-x0*x1*y[1]*y[2]*y[21]*y[30]*y[31]-x0*x1*y[1]*y[3]*y\
[21]*y[30]*y[31]-x0*x1*y[1]*y[4]*y[21]*y[30]*y[31]-2.*x0*y[1]*y[2]*y[5]*y[2\
...
[21]*y[30]*y[31]*y[32]*y[33]*y[34]+x0*y[1]*y[2]*y[5]*y[7]*y[17]*y[18]*y[35]\
...
y[36]=pow(y[33],2);
y[37]=pow(y[34],2);
FOUT=(lambda*(-(x0*x1*y[1]*y[2]*y[12]*y[20]*y[22])-x0*y[1]*y[3]*y[12]*y[20]*\
y[22]-x0*x1*y[1]*y[3]*y[12]*y[20]*y[22]-x0*x1*y[1]*y[4]*y[12]*y[20]*y[22]-2\
.*x1*y[1]*y[4]*y[5]*y[12]*y[20]*y[22]-x0*y[1]*y[2]*y[6]*y[12]*y[20]*y[22]-2\
...
y[25]*y[33]*y[34]-2.*x0*y[1]*y[2]*y[6]*y[25]*y[33]*y[34]-2.*y[1]*y[4]*y[5]*\
...
y[13]*y[21]*y[23]*y[25]*y[33]*y[34]+x0*y[1]*y[2]*y[6]*y[12]*y[20]*y[22]*y[3\
...
+x0*y[1]*y[2]*y[6]+y[1]*y[4]*y[5]*y[6]+y[7]-x0*x1*y[1]*y[8]+y[9]+y[10]+pow(\
...
0*y[1]*y[2]*y[6]*y[12]*y[20]*y[22]*y[25]*y[33]*y[34]-4.*y[1]*y[4]*y[5]*y[6]\
*y[12]*y[20]*y[22]*y[25]*y[33]*y[34]+x0*x1*y[1]*y[8]*y[12]*y[20]*y[22]*y[25\
]*y[33]*y[34]-x0*y[1]*y[2]*y[6]*y[35]*y[36]*y[37]-y[1]*y[4]*y[5]*y[6]*y[35]\
*y[36]*y[37])));
return (FOUT);
}
...
y[4]=em[2];
y[5]=x1*x1;
FOUT=(1.-x0)*x0*(-(x1*esx[0]*y[1])+x1*y[1]*y[2]+y[1]*y[3]+x1*y[1]*y[3]+x1*y[\
1]*y[4]+2.*x0*x1*y[1]*y[4]+y[1]*y[2]*y[5]+2.*x0*y[1]*y[4]*y[5]);
return (FOUT);
}
...
y[3]=em[2];
y[4]=x0*x0;
FOUT=(1.-x1)*x1*(x0*em[1]*y[1]-x0*esx[0]*y[1]+y[1]*y[2]+x0*y[1]*y[2]+2.*x0*x\
