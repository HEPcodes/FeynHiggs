...
y[71]=x2+y[70];
y[72]=pow(bi,-2);
y[73]=x0*x1*y[8]*y[16]*y[18]*y[29]*y[38]*y[39]*y[43];
y[74]=-(lambda*MYI*x1*y[8]*y[14]*y[29]*y[57]);
y[75]=y[73]+y[74];
y[76]=lambda*MYI*x2*y[14]*y[31]*y[50]*y[75];
y[77]=-(x0*x1*y[8]*y[14]*y[16]*y[18]*y[29]*y[39]*y[43]);
y[78]=lambda*MYI*x0*y[16]*y[18]*y[38]*y[60];
y[79]=y[77]+y[78];
y[80]=-(lambda*MYI*x2*y[31]*y[38]*y[50]*y[79]);
y[81]=pow(y[43],2);
y[82]=x0*x1*y[8]*y[16]*y[18]*y[29]*y[39]*y[81];
y[83]=y[57]*y[60];
y[84]=y[82]+y[83];
y[85]=2.*x1*y[1]*y[2]*y[3];
y[86]=y[9]+y[85];
y[87]=-(lambda*MYI*x2*y[31]*y[50]*y[86]);
y[88]=-(lambda*MYI*y[31]*y[50]*y[65]);
y[89]=lambda*MYI*x2*y[50]*y[65];
...
y[94]=y[1]*y[67]*y[69];
y[95]=y[1]*y[71];
y[96]=y[1]*y[67]*y[69]*y[71];
y[97]=y[1]+y[93]+y[94]+y[95]+y[96];
y[98]=pow(y[97],-2);
y[99]=pow(y[69],2);
y[100]=pow(y[71],2);
FOUT=myLog(bi)*y[72]*y[92]*y[98]+myLog(x0)*y[72]*y[92]*y[98]+myLog(1.+y[55])\
*y[72]*y[92]*y[98]+3.*myLog(y[97])*y[72]*y[92]*y[98]-2.*myLog(y[5]+y[1]*y[2\
]*y[67]+y[1]*y[2]*y[67]*y[69]+y[1]*y[2]*y[71]+y[1]*y[2]*y[69]*y[71]-y[1]*y[\
4]*y[69]*y[71]+2.*y[1]*y[2]*y[67]*y[69]*y[71]-y[1]*y[4]*y[67]*y[69]*y[71]+y\
[1]*y[2]*y[67]*y[71]*y[99]-y[1]*y[4]*y[67]*y[71]*y[99]+y[1]*y[2]*y[69]*y[10\
0]+y[1]*y[2]*y[67]*y[99]*y[100])*y[72]*y[92]*y[98];
return (FOUT);
}
