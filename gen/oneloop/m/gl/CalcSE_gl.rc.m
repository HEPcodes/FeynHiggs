{bM1 -> bMps, {dZh0h0 -> Call["dZ_h0h0_gl"[AddrOf[dZh0h0]]], 
  ...
  tdHH -> Call["td_HH_gl"[AddrOf[tdHH]]], dMsq1["h0h0"] -> 
   HoldCode[EL1L/(2*MW*SW)]*Re[tdh0], dMsq1["h0HH"] -> 
   -(dA1gl*MHin2) + CB2*MHin2*(dTB1fingl + ((1 - TB2)*Re[dZ12H1fingl])/2 + 
      (TB*(-Re[dZ11H1fingl] + Re[dZ22H1fingl] + Re[dZh0h0] - Re[dZHHHH]))/
       2) + HoldCode[EL1L/(2*MW*SW)]*Re[tdHH], 
 ...
 {dZh0h0 -> Call["dZ_h0h0_gl"[AddrOf[dZh0h0]]], 
  ...
  tdHH -> Call["td_HH_gl"[AddrOf[tdHH]]], dMsq1["A0G0"] -> 
   dBn1gl*MHin2 - dMsq1["h0HH"], dMsq1["G0G0"] -> 0, dMsq1["GmGp"] -> 0, 
  dMsq1["h0A0"] -> HoldCode[EL1L/(2*MW*SW)]*Re[tdA0], dMsq1["h0G0"] -> 0, 
  dMsq1["HHA0"] -> 0, dMsq1["HHG0"] -> HoldCode[EL1L/(2*MW*SW)]*Re[tdA0], 
  dZ1["A0A0"] -> dZ1["HHHH"], dZ1["A0G0"] -> -dZ1["h0HH"], 
  dZ1["G0G0"] -> dZ1["h0h0"], dZ1["GmGp"] -> dZ1["G0G0"], 
  dZ1["h0A0"] -> -Im[dZ12H1fingl], dZ1["h0G0"] -> 0, dZ1["HHA0"] -> 0, 
  dZ1["HHG0"] -> -Im[dZ12H1fingl], dZ1["HmGp"] -> 
   dZ1["A0G0"] + I*Im[dZ12H1fingl], dZ1["HmHp"] -> dZ1["A0A0"], 
  dMsq1["HmGp"] -> (MHin2*(dZ1["A0G0"] - I*Im[dZ12H1fingl]))/2 - 
    (MHin2*(dZ1["A0G0"] + I*Im[dZ12H1fingl]))/2 - 
    CB2*MHin2*(Conjugate[dTB1fingl] + ((1 - TB2)*Re[dZ12H1fingl])/2 + 
      (TB*(-Re[dZ11H1fingl] + Re[dZ22H1fingl] + Re[dZh0h0] - Re[dZHHHH]))/
       2) + HoldCode[EL1L/(2*MW*SW)]*((-I)*Re[tdA0] - Re[tdHH]), 
