{{-dMHiggs1[3, 3] + (k2 - MA02)*dZHiggs1[3, 3]}, 
 {(-3*Alfa1L*B0i[bb0, k2, MSf2[Sfe3, tM1, Gen3], MSf2[Sfe4, tM1, Gen3]]*
  ...
  (Alfa1L*A0[MSf2[Sfe3, tM1, Gen3]]*SumOver[Gen3, 3]*SumOver[Sfe3, 2]*
    (6*CB2*CW2*Mf2[tM1, Gen3]*(USf2[Sfe3, 1, tM1, Gen3] + 
       USf2[Sfe3, 2, tM1, Gen3]) + C2B*MW2*SB2*
      ((1 - 4*CW2)*USf2[Sfe3, 1, tM1, Gen3] - 
       4*SW2*USf2[Sfe3, 2, tM1, Gen3])))/(16*CW2*MW2*Pi*SB2*SW2), 
 ...
 {(-3*Alfa1L*B0i[bb0, k2, MSf2[Sfe3, bM1, Gen3], MSf2[Sfe4, bM1, Gen3]]*
  ...
  (Alfa1L*A0[MSf2[Sfe3, bM1, Gen3]]*SumOver[Gen3, 3]*SumOver[Sfe3, 2]*
    ((C2B*CB2*(1 + 2*CW2)*MW2 + 6*CW2*SB2*Mf2[bM1, Gen3])*
      USf2[Sfe3, 1, bM1, Gen3] + 2*(C2B*CB2*MW2*SW2 + 
       3*CW2*SB2*Mf2[bM1, Gen3])*USf2[Sfe3, 2, bM1, Gen3]))/
 ...
 {-(Alfa1L*B0i[bb0, k2, MSf2[Sfe3, 2, Gen3], MSf2[Sfe4, 2, Gen3]]*
  ...
  (Alfa1L*A0[MSf2[Sfe3, 2, Gen3]]*SumOver[Gen3, 3]*SumOver[Sfe3, 2]*
    ((C2B*CB2*(-1 + 2*CW2)*MW2 + 2*CW2*SB2*Mf2[2, Gen3])*
      USf2[Sfe3, 1, 2, Gen3] + 2*(C2B*CB2*MW2*SW2 + CW2*SB2*Mf2[2, Gen3])*
      USf2[Sfe3, 2, 2, Gen3]))/(16*CB2*CW2*MW2*Pi*SW2), 
  -(Alfa1L*(C2B*MW2*A0[MSf2[1, 1, Gen3]] + 4*CW2*TB2*(A0[Mf2[2, Gen3]] + 
