{{-dMWsq1 + dZW1*(k2 - MW2)}, 
 {(-3*Alfa1L*B0i[bb00, k2, MASf2[All3, tM1], MASf2[All4, bM1]]*
    ...
    UASfC[All4, Ind2, bM1])/(2*Pi*SW2), 
  (3*Alfa1L*SumOver[All3, 6]*SumOver[Ind1, 3]*
    (A0[MASf2[All3, bM1]]*UASf[All3, Ind1, bM1]*UASfC[All3, Ind1, bM1] + 
     A0[MASf2[All3, tM1]]*UASf[All3, Ind1, tM1]*UASfC[All3, Ind1, tM1]))/
   (8*Pi*SW2), (3*Alfa1L*CKMin[Gen3, Gen4]*CKMinC[Gen3, Gen4]*
 ...
 {-(Alfa1L*B0i[bb00, k2, MASf2[All3, 2], MASf2[Gen3, 1]]*SumOver[All3, 6]*
     SumOver[Gen3, 3]*SumOver[Ind1, 3]*SumOver[Ind2, 3]*UASf[All3, Ind1, 2]*
     UASf[Gen3, Ind2, 1]*UASfC[All3, Ind2, 2]*UASfC[Gen3, Ind1, 1])/
   (2*Pi*SW2), (Alfa1L*A0[MASf2[All3, 2]]*SumOver[All3, 6]*SumOver[Ind1, 3]*
    UASf[All3, Ind1, 2]*UASfC[All3, Ind1, 2])/(8*Pi*SW2), 
  (Alfa1L*(A0[MASf2[Gen3, 1]] - 2*(A0[Mf2[2, Gen3]] - 
       2*B0i[bb00, k2, 0, Mf2[2, Gen3]] + k2*B0i[bb1, k2, 0, Mf2[2, Gen3]]))*
 ...
 {(Alfa1L*SumOver[Cha3, 2]*SumOver[Neu3, 4]*
  ...
  (Alfa1L*(4*(-(CW2^2*(3*k2 + 2*MZ2)) + MW2*SW2^2)*B0i[bb0, k2, MW2, MZ2] + 
     CW2*(A0[MA02] + A0[Mh02] + A0[MHH2] + 2*A0[MHp2] + 6*A0[MW2] + 
       (1 + 12*CW2)*A0[MZ2] + 4*((-3*k2 + MW2)*SW2*B0i[bb0, k2, 0, MW2] + 
         MW2*(SBA2*B0i[bb0, k2, Mh02, MW2] + CBA2*B0i[bb0, k2, MHH2, MW2])) - 
       4*(B0i[bb00, k2, MA02, MHp2] + SBA2*(B0i[bb00, k2, Mh02, MW2] + 
           B0i[bb00, k2, MHH2, MHp2]) + CBA2*(B0i[bb00, k2, Mh02, MHp2] + 
           B0i[bb00, k2, MHH2, MW2]) + B0i[bb00, k2, MZ2, MW2]) + 
       SW2*(-32*B0i[bb00, k2, MW2, 0] + 8*k2*B0i[bb1, k2, MW2, 0])) + 
     CW2^2*(-32*B0i[bb00, k2, MW2, MZ2] + 8*k2*B0i[bb1, k2, MW2, MZ2])))/
   (16*CW2*Pi*SW2)}}
