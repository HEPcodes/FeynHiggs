...
s Alfa, Alfa0, Alfa2, Alfas, Alfas2, AlfasDb, AlfasMH, bBR, C2B, CA,
  CA2, CAB, CB, CB2, CBA, CBA2, cG1, cG2, cR1, CW, CW2, EL0, GSDb,
  GSMH, hgagaQ, hgagaSq, hno, m1, m12, MA0, MA02, MB, MB2, MC, MC2, MD,
  MD2, ME, ME2, MGl, MGl2, Mh0, Mh02, MHH, MHH2, MHp, MHp2, MHptree,
  MHptree2, Mino3, Mino3C, ML, ML2, MM, MM2, MS, MS2, MT, MT2, MU, MU2,
  MUE, MUEC, MW, MW2, MZ, MZ2, pG1, pG2, pG3, Pi, pM1, SA, SA2, SAB,
  SB, SB2, SBA, SBA2, SqrtEGl, SqrtEGlC, SW, SW2, TB, TB2, tH;
cf addM, Den, dirM, Hel, hff, IndexDelta, IndexSum, intM, Kf, KfC,
  List, MASf, MASf2, MCha, MCha2, Mf, Mf2, Mfy, Mfy2, MHiggs, MHiggs2,
  MHiggstree, MHiggstree2, MNeu, MNeu2, MSf, MSf2, powM, SumOver, UASf,
  UASfC, UCha, UChaC, VCha, VChaC, ZHiggs;
i All4 = 6, Cha4 = 2, Gen4 = 3, j1 = 0, j2 = 0, Lor1, Lor2, Lor3,
  Lor4, Lor5, Lor6, Lor7, Lor8, sM = 0;
...
L T1G1 = (i_*cR1*ec2(Lor1)*ec3(Lor2)*intM(Den(q1, pM1^2), 
    Den(-k2 + q1, pM1^2), Den(-k2 - k3 + q1, pM1^2))*
   g_(1)*(pM1 - g_(1, k1) + g_(1, q1))*(pG1*g_(1, Lor2))*
    (pM1 - g_(1, k2) + g_(1, q1))*(pG1*g_(1, Lor1))*
    (pM1 + g_(1, q1))*((pG3*g6_(1))/2 + (pG2*g7_(1))/2))/
  (16*Pi^2);

L T1G2 = (i_*cG2*cR1*pG1^2*ec2(Lor1)*ec3(Lor2)*
   intM(Den(q1, pM1^2), Den(-k2 + q1, pM1^2), Den(-k2 - k3 + q1, pM1^2))*
   (-k2(Lor1) + 2*q1(Lor1))*(2*k2(Lor2) + k3(Lor2) - 2*q1(Lor2)))/
  (16*Pi^2);

L T1G3 = (i_*addM(-(i_*EL0*MW*SBA*ZHiggs(hno, 1))/(2*SW), 
    -(i_*CBA*EL0*MW*ZHiggs(hno, 2))/(2*SW))*ec2(Lor1)*ec3(Lor2)*
   intM(Den(q1, MW2), Den(-k2 + q1, MW2), Den(-k2 - k3 + q1, MW2))*
   (pG1*(k2(Lor1) - q1(Lor1)) + pG2*q1(Lor1))*
   (pG1*(k1(Lor2) - q1(Lor2)) + pG2*(-k2(Lor2) + q1(Lor2))))/(16*Pi^2);

L T1G4 = -(i_*pG1^2*d_(Lor3, Lor4)*d_(Lor3, Lor5)*
    d_(Lor5, Lor6)*d_(Lor7, Lor8)*
    addM((i_*EL0*MW*SBA*ZHiggs(hno, 1))/SW, 
     (i_*CBA*EL0*MW*ZHiggs(hno, 2))/SW)*ec2(Lor1)*ec3(Lor2)*
    intM(Den(q1, MW2), Den(-k2 + q1, MW2), Den(-k2 - k3 + q1, MW2))*
    (d_(Lor4, Lor7)*(k2(Lor1) - 2*q1(Lor1)) + 
     d_(Lor1, Lor7)*(-2*k2(Lor4) + q1(Lor4)) + 
     d_(Lor1, Lor4)*(k2(Lor7) + q1(Lor7)))*
    (d_(Lor6, Lor8)*(-2*k2(Lor2) - k3(Lor2) + 2*q1(Lor2)) + 
     d_(Lor2, Lor8)*(k2(Lor6) - k3(Lor6) - q1(Lor6)) + 
     d_(Lor2, Lor6)*(k2(Lor8) + 2*k3(Lor8) - q1(Lor8))))/(16*Pi^2);

L T1G5 = -(i_*Alfa0*MW2*d_(Lor1, Lor3)*d_(Lor2, Lor4)*
    d_(Lor3, Lor4)*addM(-(i_*EL0*SBA*MHiggs2(1)*ZHiggs(hno, 1))/
      (2*MW*SW), -(i_*CBA*EL0*MHiggs2(2)*ZHiggs(hno, 2))/(2*MW*SW))*
    ec2(Lor1)*ec3(Lor2)*intM(Den(q1, MW2), Den(-k2 + q1, MW2), 
     Den(-k2 - k3 + q1, MW2)))/(4*Pi);

L T1G6 = -(EL0*MW*pG1*pG2*d_(Lor2, Lor4)*d_(Lor3, Lor4)*
    ec2(Lor1)*ec3(Lor2)*intM(Den(q1, MW2), Den(-k2 + q1, MW2), 
     Den(-k2 - k3 + q1, MW2))*(-k2(Lor1) + 2*q1(Lor1))*
    (k1(Lor3) + q1(Lor3)))/(16*Pi^2);

L T1G7 = -(EL0*MW*pG1*pG2*d_(Lor1, Lor4)*d_(Lor3, Lor4)*
    ec2(Lor1)*ec3(Lor2)*intM(Den(q1, MW2), Den(-k2 + q1, MW2), 
     Den(-k2 - k3 + q1, MW2))*(2*k2(Lor2) + k3(Lor2) - 2*q1(Lor2))*
    (2*k1(Lor3) - q1(Lor3)))/(16*Pi^2);

L T1G8 = (EL0*MW*pG1*pG2*d_(Lor1, Lor5)*d_(Lor3, Lor4)*
   d_(Lor5, Lor6)*ec2(Lor1)*ec3(Lor2)*intM(Den(q1, MW2), 
    Den(-k2 + q1, MW2), Den(-k2 - k3 + q1, MW2))*(k1(Lor3) + q1(Lor3))*
   (d_(Lor4, Lor6)*(-2*k2(Lor2) - k3(Lor2) + 2*q1(Lor2)) + 
    d_(Lor2, Lor6)*(k2(Lor4) - k3(Lor4) - q1(Lor4)) + 
    d_(Lor2, Lor4)*(k2(Lor6) + 2*k3(Lor6) - q1(Lor6))))/(16*Pi^2);

L T1G9 = (EL0*MW*pG1*pG2*d_(Lor2, Lor6)*d_(Lor3, Lor4)*
   d_(Lor5, Lor6)*ec2(Lor1)*ec3(Lor2)*intM(Den(q1, MW2), 
    Den(-k2 + q1, MW2), Den(-k2 - k3 + q1, MW2))*(2*k1(Lor3) - q1(Lor3))*
   (d_(Lor4, Lor5)*(k2(Lor1) - 2*q1(Lor1)) + 
    d_(Lor1, Lor5)*(-2*k2(Lor4) + q1(Lor4)) + 
    d_(Lor1, Lor4)*(k2(Lor5) + q1(Lor5))))/(16*Pi^2);

L T1G10 = (i_*Alfa0*MW2*d_(Lor1, Lor4)*d_(Lor2, Lor6)*
   d_(Lor3, Lor4)*d_(Lor3, Lor5)*d_(Lor5, Lor6)*
   addM((i_*EL0*MW*SBA*ZHiggs(hno, 1))/SW, 
    (i_*CBA*EL0*MW*ZHiggs(hno, 2))/SW)*ec2(Lor1)*ec3(Lor2)*
   intM(Den(q1, MW2), Den(-k2 + q1, MW2), Den(-k2 - k3 + q1, MW2)))/
  (4*Pi);

L T2G1 = -(cG1*cR1*pG2*d_(Lor1, Lor2)*ec2(Lor1)*ec3(Lor2)*
    intM(Den(q1, pM1^2), Den(-k2 - k3 + q1, pM1^2)))/(32*Pi^2);

L T2G2 = -(d_(Lor3, Lor4)*d_(Lor3, Lor5)*
    (4*i_*Alfa0*Pi*d_(Lor1, Lor6)*d_(Lor2, Lor4) + 
     4*i_*Alfa0*Pi*d_(Lor1, Lor4)*d_(Lor2, Lor6) - 
     8*i_*Alfa0*Pi*d_(Lor1, Lor2)*d_(Lor4, Lor6))*d_(Lor5, Lor6)*
    addM((i_*EL0*MW*SBA*ZHiggs(hno, 1))/SW, 
     (i_*CBA*EL0*MW*ZHiggs(hno, 2))/SW)*ec2(Lor1)*ec3(Lor2)*
    intM(Den(q1, MW2), Den(-k2 - k3 + q1, MW2)))/(16*Pi^2);

L T3G1 = (i_*EL0*MW*d_(Lor1, Lor3)*d_(Lor2, Lor4)*
   d_(Lor3, Lor4)*addM((2*i_*Alfa0*Pi*SBA*ZHiggs(hno, 1))/SW, 
    (2*i_*Alfa0*CBA*Pi*ZHiggs(hno, 2))/SW)*ec2(Lor1)*ec3(Lor2)*
   intM(Den(q1, MW2), Den(k2 + q1, MW2)))/(16*Pi^2);

L T4G1 = (i_*EL0*MW*d_(Lor1, Lor4)*d_(Lor2, Lor3)*
   d_(Lor3, Lor4)*addM((2*i_*Alfa0*Pi*SBA*ZHiggs(hno, 1))/SW, 
    (2*i_*Alfa0*CBA*Pi*ZHiggs(hno, 2))/SW)*ec2(Lor1)*ec3(Lor2)*
   intM(Den(q1, MW2), Den(k3 + q1, MW2)))/(16*Pi^2);
...
ab Alfa, Alfa0, Alfa2, Alfas, Alfas2, AlfasDb, AlfasMH, bBR, C2B, CA,
  CA2, CAB, CB, CB2, CBA, CBA2, CW, CW2, EL0, GSDb, GSMH, hff, hgagaQ,
  hgagaSq, hno, Kf, KfC, List, m1, m12, MA0, MA02, MASf, MASf2, MB,
  MB2, MC, MC2, MCha, MCha2, MD, MD2, ME, ME2, Mf, Mf2, Mfy, Mfy2, MGl,
  MGl2, Mh0, Mh02, MHH, MHH2, MHiggs, MHiggs2, MHiggstree, MHiggstree2,
  MHp, MHp2, MHptree, MHptree2, Mino3, Mino3C, ML, ML2, MM, MM2, MNeu,
  MNeu2, MS, MS2, MSf, MSf2, MT, MT2, MU, MU2, MUE, MUEC, MW, MW2, MZ,
  MZ2, Pi, SA, SA2, SAB, SB, SB2, SBA, SBA2, SqrtEGl, SqrtEGlC, SW,
  SW2, TB, TB2, tH;
#endprocedure

#procedure Insertions
L iT1G1 = T1G1*(replace_(pM1, MCha(Cha4), pG1, -(i_*EL0), 
    pG2, addM((i_*EL0*addM(SA*UChaC(Cha4, 2)*VChaC(Cha4, 1), 
        -(CA*UChaC(Cha4, 1)*VChaC(Cha4, 2)))*powM(2, -1/2)*
       ZHiggs(hno, 1))/SW, 
     -((i_*EL0*addM(CA*UChaC(Cha4, 2)*VChaC(Cha4, 1), 
         SA*UChaC(Cha4, 1)*VChaC(Cha4, 2))*powM(2, -1/2)*ZHiggs(hno, 2))/
       SW), -((EL0*addM(SB*UChaC(Cha4, 2)*VChaC(Cha4, 1), 
         CB*UChaC(Cha4, 1)*VChaC(Cha4, 2))*powM(2, -1/2)*ZHiggs(hno, 3))/
       SW)), pG3, addM((i_*EL0*addM(SA*UCha(Cha4, 2)*VCha(Cha4, 1), 
        -(CA*UCha(Cha4, 1)*VCha(Cha4, 2)))*powM(2, -1/2)*ZHiggs(hno, 1))/
      SW, -((i_*EL0*addM(CA*UCha(Cha4, 2)*VCha(Cha4, 1), 
         SA*UCha(Cha4, 1)*VCha(Cha4, 2))*powM(2, -1/2)*ZHiggs(hno, 2))/
       SW), (EL0*addM(SB*UCha(Cha4, 2)*VCha(Cha4, 1), 
        CB*UCha(Cha4, 1)*VCha(Cha4, 2))*powM(2, -1/2)*ZHiggs(hno, 3))/
      SW), cR1, SumOver(Cha4, 2)) + replace_(pM1, MCha(Cha4), pG1, 
    i_*EL0, pG2, addM((i_*EL0*addM(SA*UChaC(Cha4, 2)*VChaC(Cha4, 1), 
        -(CA*UChaC(Cha4, 1)*VChaC(Cha4, 2)))*powM(2, -1/2)*
       ZHiggs(hno, 1))/SW, 
     -((i_*EL0*addM(CA*UChaC(Cha4, 2)*VChaC(Cha4, 1), 
         SA*UChaC(Cha4, 1)*VChaC(Cha4, 2))*powM(2, -1/2)*ZHiggs(hno, 2))/
      ...
      SW, -((i_*EL0*addM(CA*UCha(Cha4, 2)*VCha(Cha4, 1), 
       ...
       SW), (EL0*addM(SB*UCha(Cha4, 2)*VCha(Cha4, 1), 
        CB*UCha(Cha4, 1)*VCha(Cha4, 2))*powM(2, -1/2)*ZHiggs(hno, 3))/
      SW), cR1, SumOver(Cha4, 2)) + replace_(pM1, Mf(2, Gen4), pG1, 
    -(i_*EL0), pG2, addM((i_*EL0*SA*Mf(2, Gen4)*ZHiggs(hno, 1))/
      (2*CB*MW*SW), -(i_*CA*EL0*Mf(2, Gen4)*ZHiggs(hno, 2))/
      (2*CB*MW*SW), (EL0*TB*Mf(2, Gen4)*ZHiggs(hno, 3))/(2*MW*SW)), pG3, 
    addM((i_*EL0*SA*Mf(2, Gen4)*ZHiggs(hno, 1))/(2*CB*MW*SW), 
     -(i_*CA*EL0*Mf(2, Gen4)*ZHiggs(hno, 2))/(2*CB*MW*SW), 
     -(EL0*TB*Mf(2, Gen4)*ZHiggs(hno, 3))/(2*MW*SW)), cR1, 
    SumOver(Gen4, 3)) + replace_(pM1, Mf(2, Gen4), pG1, i_*EL0, pG2, 
    addM((i_*EL0*SA*Mf(2, Gen4)*ZHiggs(hno, 1))/(2*CB*MW*SW), 
     -(i_*CA*EL0*Mf(2, Gen4)*ZHiggs(hno, 2))/(2*CB*MW*SW), 
     (EL0*TB*Mf(2, Gen4)*ZHiggs(hno, 3))/(2*MW*SW)), pG3, 
    addM((i_*EL0*SA*Mf(2, Gen4)*ZHiggs(hno, 1))/(2*CB*MW*SW), 
     -(i_*CA*EL0*Mf(2, Gen4)*ZHiggs(hno, 2))/(2*CB*MW*SW), 
     -(EL0*TB*Mf(2, Gen4)*ZHiggs(hno, 3))/(2*MW*SW)), cR1, 
    SumOver(Gen4, 3)) + replace_(pM1, Mf(4, Gen4), pG1, -(i_*EL0)/3, 
    pG2, addM((i_*EL0*hgagaQ*SA*hff(1, Gen4, Gen4)*Mf(bBR, Gen4)*
       ZHiggs(hno, 1))/(2*CB*MW*SW), 
     -(i_*CA*EL0*hgagaQ*hff(2, Gen4, Gen4)*Mf(bBR, Gen4)*
        ZHiggs(hno, 2))/(2*CB*MW*SW), (EL0*hgagaQ*TB*hff(3, Gen4, Gen4)*
       Mf(bBR, Gen4)*ZHiggs(hno, 3))/(2*MW*SW)), pG3, 
    addM((i_*EL0*hgagaQ*SA*hff(1, Gen4, Gen4)*Mf(bBR, Gen4)*
       ZHiggs(hno, 1))/(2*CB*MW*SW), 
     -(i_*CA*EL0*hgagaQ*hff(2, Gen4, Gen4)*Mf(bBR, Gen4)*
        ZHiggs(hno, 2))/(2*CB*MW*SW), 
     -(EL0*hgagaQ*TB*hff(3, Gen4, Gen4)*Mf(bBR, Gen4)*ZHiggs(hno, 3))/
      (2*MW*SW)), cR1, 3*SumOver(Gen4, 3)) + 
   replace_(pM1, Mf(4, Gen4), pG1, (i_*EL0)/3, pG2, 
    addM((i_*EL0*hgagaQ*SA*hff(1, Gen4, Gen4)*Mf(bBR, Gen4)*
       ZHiggs(hno, 1))/(2*CB*MW*SW), 
     -(i_*CA*EL0*hgagaQ*hff(2, Gen4, Gen4)*Mf(bBR, Gen4)*
        ZHiggs(hno, 2))/(2*CB*MW*SW), (EL0*hgagaQ*TB*hff(3, Gen4, Gen4)*
    ...
    addM((i_*EL0*hgagaQ*SA*hff(1, Gen4, Gen4)*Mf(bBR, Gen4)*
     ...
     -(EL0*hgagaQ*TB*hff(3, Gen4, Gen4)*Mf(bBR, Gen4)*ZHiggs(hno, 3))/
      (2*MW*SW)), cR1, 3*SumOver(Gen4, 3)) + 
   replace_(pM1, Mf(tH, Gen4), pG1, (-2*i_*EL0)/3, pG2, 
    addM(-(i_*CA*EL0*hgagaQ*Mf(tH, Gen4)*ZHiggs(hno, 1))/(2*MW*SB*SW), 
     -(i_*EL0*hgagaQ*SA*Mf(tH, Gen4)*ZHiggs(hno, 2))/(2*MW*SB*SW), 
     (EL0*hgagaQ*Mf(tH, Gen4)*ZHiggs(hno, 3))/(2*MW*SW*TB)), pG3, 
    addM(-(i_*CA*EL0*hgagaQ*Mf(tH, Gen4)*ZHiggs(hno, 1))/(2*MW*SB*SW), 
     -(i_*EL0*hgagaQ*SA*Mf(tH, Gen4)*ZHiggs(hno, 2))/(2*MW*SB*SW), 
     -(EL0*hgagaQ*Mf(tH, Gen4)*ZHiggs(hno, 3))/(2*MW*SW*TB)), cR1, 
    3*SumOver(Gen4, 3)) + replace_(pM1, Mf(tH, Gen4), pG1, 
    (2*i_*EL0)/3, pG2, 
    addM(-(i_*CA*EL0*hgagaQ*Mf(tH, Gen4)*ZHiggs(hno, 1))/(2*MW*SB*SW), 
     -(i_*EL0*hgagaQ*SA*Mf(tH, Gen4)*ZHiggs(hno, 2))/(2*MW*SB*SW), 
     (EL0*hgagaQ*Mf(tH, Gen4)*ZHiggs(hno, 3))/(2*MW*SW*TB)), pG3, 
...
L iT1G2 = T1G2*(replace_(pM1, MHp, pG1, -(i_*EL0), cG2, 
    addM(-((i_*EL0*MW*addM((C2B*SAB)/(2*CW2), SBA)*ZHiggs(hno, 1))/
       SW), -((i_*EL0*MW*addM(CBA, -(C2B*CAB)/(2*CW2))*ZHiggs(hno, 2))/
       SW)), cR1, 1) + replace_(pM1, MHp, pG1, i_*EL0, cG2, 
    addM(-((i_*EL0*MW*addM((C2B*SAB)/(2*CW2), SBA)*ZHiggs(hno, 1))/
       SW), -((i_*EL0*MW*addM(CBA, -(C2B*CAB)/(2*CW2))*ZHiggs(hno, 2))/
       SW)), cR1, 1) + replace_(pM1, MW, pG1, -(i_*EL0), cG2, 
    addM(-(i_*EL0*SBA*MHiggs2(1)*ZHiggs(hno, 1))/(2*MW*SW), 
     -(i_*CBA*EL0*MHiggs2(2)*ZHiggs(hno, 2))/(2*MW*SW)), cR1, 1) + 
   replace_(pM1, MW, pG1, i_*EL0, cG2, 
    addM(-(i_*EL0*SBA*MHiggs2(1)*ZHiggs(hno, 1))/(2*MW*SW), 
     -(i_*CBA*EL0*MHiggs2(2)*ZHiggs(hno, 2))/(2*MW*SW)), cR1, 1) + 
   replace_(pM1, MASf(All4, 2), pG1, -(i_*EL0), cG2, 
    addM(IndexSum(IndexSum(
        (i_*EL0*addM(addM(addM(CB*MW*MZ*SAB*addM(-1, 2*SW2), 2*CW*SA*
                Mf2(2, j1))*IndexDelta(j1, j2)*UASf(All4, j2, 2), 
             CW*addM(SA*Kf(j1, j2, 2), CA*MUEC*IndexDelta(j1, j2)*
                Mf(2, j1))*UASf(All4, addM(3, j2), 2))*UASfC(All4, j1, 
             2), addM(CW*addM(SA*KfC(j2, j1, 2), CA*MUE*IndexDelta(j1, 
                 j2)*Mf(2, j1))*UASf(All4, j2, 2), -2*CB*MW*MZ*SAB*SW2*
              IndexDelta(j1, j2)*UASf(All4, addM(3, j2), 2), 
             2*CW*SA*IndexDelta(j1, j2)*Mf2(2, j1)*UASf(All4, addM(3, 
                j2), 2))*UASfC(All4, addM(3, j1), 2)))/(2*CB*CW*MW*SW), 
        j2, 3), j1, 3)*ZHiggs(hno, 1), 
     IndexSum(IndexSum((i_*EL0*addM(
           addM(addM(CAB*CB*MW*MZ*addM(1, -2*SW2), -2*CA*CW*Mf2(2, j1))*
              IndexDelta(j1, j2)*UASf(All4, j2, 2), 
             CW*addM(-(CA*Kf(j1, j2, 2)), MUEC*SA*IndexDelta(j1, j2)*
                Mf(2, j1))*UASf(All4, addM(3, j2), 2))*UASfC(All4, j1, 
             2), addM(CW*addM(-(CA*KfC(j2, j1, 2)), MUE*SA*IndexDelta(
                 j1, j2)*Mf(2, j1))*UASf(All4, j2, 2), 2*CAB*CB*MW*MZ*
              SW2*IndexDelta(j1, j2)*UASf(All4, addM(3, j2), 2), 
             -2*CA*CW*IndexDelta(j1, j2)*Mf2(2, j1)*UASf(All4, addM(3, 
                j2), 2))*UASfC(All4, addM(3, j1), 2)))/(2*CB*CW*MW*SW), 
        j2, 3), j1, 3)*ZHiggs(hno, 2), 
     IndexSum(IndexSum(-(EL0*addM(-(addM(TB*Kf(j1, j2, 2), MUEC*
                IndexDelta(j1, j2)*Mf(2, j1))*UASf(All4, addM(3, j2), 2)*
              UASfC(All4, j1, 2)), addM(TB*KfC(j2, j1, 2), 
              MUE*IndexDelta(j1, j2)*Mf(2, j1))*UASf(All4, j2, 2)*
             UASfC(All4, addM(3, j1), 2)))/(2*MW*SW), j2, 3), j1, 3)*
      ZHiggs(hno, 3)), cR1, SumOver(All4, 6)) + 
   replace_(pM1, MASf(All4, 2), pG1, i_*EL0, cG2, 
    addM(IndexSum(IndexSum(
        (i_*EL0*addM(addM(addM(CB*MW*MZ*SAB*addM(-1, 2*SW2), 2*CW*SA*
                Mf2(2, j1))*IndexDelta(j1, j2)*UASf(All4, j2, 2), 
     ...
     IndexSum(IndexSum(-(EL0*addM(-(addM(TB*Kf(j1, j2, 2), MUEC*
             ...
             UASfC(All4, addM(3, j1), 2)))/(2*MW*SW), j2, 3), j1, 3)*
      ZHiggs(hno, 3)), cR1, SumOver(All4, 6)) + 
   replace_(pM1, MASf(All4, bBR), pG1, -(i_*EL0)/3, cG2, 
    addM(hgagaSq*IndexSum(IndexSum(
        (i_*EL0*addM(addM(addM(CB*MW*MZ*SAB*addM(-3, 2*SW2), 6*CW*SA*
                Mf2(bBR, j1))*IndexDelta(j1, j2)*UASf(All4, j2, bBR), 
             3*CW*addM(SA*Kf(j1, j2, bBR), CA*MUEC*IndexDelta(j1, j2)*
                Mf(bBR, j1))*UASf(All4, addM(3, j2), bBR))*
            UASfC(All4, j1, bBR), addM(3*CW*addM(SA*KfC(j2, j1, bBR), CA*
                MUE*IndexDelta(j1, j2)*Mf(bBR, j1))*UASf(All4, j2, bBR), 
             -2*CB*MW*MZ*SAB*SW2*IndexDelta(j1, j2)*UASf(All4, addM(3, 
                j2), bBR), 6*CW*SA*IndexDelta(j1, j2)*Mf2(bBR, j1)*
              UASf(All4, addM(3, j2), bBR))*UASfC(All4, addM(3, j1), 
             bBR)))/(6*CB*CW*MW*SW), j2, 3), j1, 3)*ZHiggs(hno, 1), 
     hgagaSq*IndexSum(IndexSum(
        -(i_*EL0*addM(addM(addM(CAB*CB*MW*MZ*addM(-3, 2*SW2), 
                6*CA*CW*Mf2(bBR, j1))*IndexDelta(j1, j2)*UASf(All4, j2, 
                bBR), 3*CW*addM(CA*Kf(j1, j2, bBR), -(MUEC*SA*IndexDelta(
                   j1, j2)*Mf(bBR, j1)))*UASf(All4, addM(3, j2), bBR))*
             UASfC(All4, j1, bBR), addM(3*CW*addM(CA*KfC(j2, j1, bBR), 
                -(MUE*SA*IndexDelta(j1, j2)*Mf(bBR, j1)))*UASf(All4, j2, 
                bBR), -2*CAB*CB*MW*MZ*SW2*IndexDelta(j1, j2)*UASf(All4, 
                addM(3, j2), bBR), 6*CA*CW*IndexDelta(j1, j2)*Mf2(bBR, 
                j1)*UASf(All4, addM(3, j2), bBR))*UASfC(All4, 
              addM(3, j1), bBR)))/(6*CB*CW*MW*SW), j2, 3), j1, 3)*
      ZHiggs(hno, 2), hgagaSq*IndexSum(IndexSum(
        -(EL0*addM(-(addM(TB*Kf(j1, j2, bBR), MUEC*IndexDelta(j1, j2)*
                Mf(bBR, j1))*UASf(All4, addM(3, j2), bBR)*
              UASfC(All4, j1, bBR)), addM(TB*KfC(j2, j1, bBR), 
              MUE*IndexDelta(j1, j2)*Mf(bBR, j1))*UASf(All4, j2, bBR)*
             UASfC(All4, addM(3, j1), bBR)))/(2*MW*SW), j2, 3), j1, 3)*
      ZHiggs(hno, 3)), cR1, 3*SumOver(All4, 6)) + 
   replace_(pM1, MASf(All4, bBR), pG1, (i_*EL0)/3, cG2, 
    addM(hgagaSq*IndexSum(IndexSum(
        (i_*EL0*addM(addM(addM(CB*MW*MZ*SAB*addM(-3, 2*SW2), 6*CW*SA*
                Mf2(bBR, j1))*IndexDelta(j1, j2)*UASf(All4, j2, bBR), 
     ...
     hgagaSq*IndexSum(IndexSum(
      ...
      ZHiggs(hno, 2), hgagaSq*IndexSum(IndexSum(
        -(EL0*addM(-(addM(TB*Kf(j1, j2, bBR), MUEC*IndexDelta(j1, j2)*
             ...
             UASfC(All4, addM(3, j1), bBR)))/(2*MW*SW), j2, 3), j1, 3)*
      ZHiggs(hno, 3)), cR1, 3*SumOver(All4, 6)) + 
   replace_(pM1, MASf(All4, tH), pG1, (-2*i_*EL0)/3, cG2, 
    addM(hgagaSq*IndexSum(IndexSum(
        -(i_*EL0*addM(addM(addM(MW*MZ*SAB*SB*addM(-3, 4*SW2), 
                6*CA*CW*Mf2(tH, j1))*IndexDelta(j1, j2)*UASf(All4, j2, 
                tH), 3*CW*addM(CA*Kf(j1, j2, tH), MUEC*SA*IndexDelta(j1, 
                  j2)*Mf(tH, j1))*UASf(All4, addM(3, j2), tH))*
             UASfC(All4, j1, tH), addM(3*CW*addM(CA*KfC(j2, j1, tH), 
                MUE*SA*IndexDelta(j1, j2)*Mf(tH, j1))*UASf(All4, j2, 
                tH), -4*MW*MZ*SAB*SB*SW2*IndexDelta(j1, j2)*UASf(All4, 
                addM(3, j2), tH), 6*CA*CW*IndexDelta(j1, j2)*Mf2(tH, 
                j1)*UASf(All4, addM(3, j2), tH))*UASfC(All4, 
              addM(3, j1), tH)))/(6*CW*MW*SB*SW), j2, 3), j1, 3)*
      ZHiggs(hno, 1), hgagaSq*IndexSum(IndexSum(
        -(i_*EL0*addM(addM(addM(CAB*MW*MZ*SB*addM(3, -4*SW2), 
                6*CW*SA*Mf2(tH, j1))*IndexDelta(j1, j2)*UASf(All4, j2, 
                tH), 3*CW*addM(SA*Kf(j1, j2, tH), -(CA*MUEC*IndexDelta(
                   j1, j2)*Mf(tH, j1)))*UASf(All4, addM(3, j2), tH))*
             UASfC(All4, j1, tH), addM(3*CW*addM(SA*KfC(j2, j1, tH), 
                -(CA*MUE*IndexDelta(j1, j2)*Mf(tH, j1)))*UASf(All4, j2, 
                tH), 4*CAB*MW*MZ*SB*SW2*IndexDelta(j1, j2)*UASf(All4, 
                addM(3, j2), tH), 6*CW*SA*IndexDelta(j1, j2)*Mf2(tH, 
                j1)*UASf(All4, addM(3, j2), tH))*UASfC(All4, 
              addM(3, j1), tH)))/(6*CW*MW*SB*SW), j2, 3), j1, 3)*
      ZHiggs(hno, 2), hgagaSq*IndexSum(IndexSum(
        -(EL0*addM(-(addM(Kf(j1, j2, tH), MUEC*TB*IndexDelta(j1, j2)*
                Mf(tH, j1))*UASf(All4, addM(3, j2), tH)*UASfC(All4, j1, 
               tH)), addM(KfC(j2, j1, tH), MUE*TB*IndexDelta(j1, j2)*Mf(
                tH, j1))*UASf(All4, j2, tH)*UASfC(All4, addM(3, j1), 
              tH)))/(2*MW*SW*TB), j2, 3), j1, 3)*ZHiggs(hno, 3)), cR1, 
    3*SumOver(All4, 6)) + replace_(pM1, MASf(All4, tH), pG1, 
    (2*i_*EL0)/3, cG2, 
    addM(hgagaSq*IndexSum(IndexSum(
        -(i_*EL0*addM(addM(addM(MW*MZ*SAB*SB*addM(-3, 4*SW2), 
                6*CA*CW*Mf2(tH, j1))*IndexDelta(j1, j2)*UASf(All4, j2, 
...
L iT1G3 = T1G3*(replace_(pG1, 0, pG2, -(i_*EL0)) + 
   replace_(pG1, 0, pG2, i_*EL0) + replace_(pG1, -(i_*EL0), pG2, 
    0) + replace_(pG1, i_*EL0, pG2, 0));

L iT1G4 = T1G4*(replace_(pG1, -(i_*EL0)) + 
   replace_(pG1, i_*EL0));

L iT1G6 = T1G6*(replace_(pG1, -(i_*EL0), pG2, 
    addM(-(i_*EL0*SBA*ZHiggs(hno, 1))/(2*SW), 
     -(i_*CBA*EL0*ZHiggs(hno, 2))/(2*SW))) + 
   replace_(pG1, i_*EL0, pG2, addM((i_*EL0*SBA*ZHiggs(hno, 1))/
      (2*SW), (i_*CBA*EL0*ZHiggs(hno, 2))/(2*SW))));

L iT1G7 = T1G7*(replace_(pG1, -(i_*EL0), pG2, 
    addM(-(i_*EL0*SBA*ZHiggs(hno, 1))/(2*SW), 
     -(i_*CBA*EL0*ZHiggs(hno, 2))/(2*SW))) + 
   replace_(pG1, i_*EL0, pG2, addM((i_*EL0*SBA*ZHiggs(hno, 1))/
      (2*SW), (i_*CBA*EL0*ZHiggs(hno, 2))/(2*SW))));
...
L iT1G8 = 
 T1G8*(replace_(pG1, addM(-(i_*EL0*SBA*ZHiggs(hno, 1))/(2*SW), 
     -(i_*CBA*EL0*ZHiggs(hno, 2))/(2*SW)), pG2, i_*EL0) + 
   replace_(pG1, addM((i_*EL0*SBA*ZHiggs(hno, 1))/(2*SW), 
     (i_*CBA*EL0*ZHiggs(hno, 2))/(2*SW)), pG2, -(i_*EL0)));

L iT1G9 = 
 T1G9*(replace_(pG1, addM(-(i_*EL0*SBA*ZHiggs(hno, 1))/(2*SW), 
     -(i_*CBA*EL0*ZHiggs(hno, 2))/(2*SW)), pG2, i_*EL0) + 
   replace_(pG1, addM((i_*EL0*SBA*ZHiggs(hno, 1))/(2*SW), 
     (i_*CBA*EL0*ZHiggs(hno, 2))/(2*SW)), pG2, -(i_*EL0)));

L iT2G1 = T2G1*(replace_(pM1, MHp, cG1, 
    addM(-((i_*EL0*MW*addM((C2B*SAB)/(2*CW2), SBA)*ZHiggs(hno, 1))/
       SW), -((i_*EL0*MW*addM(CBA, -(C2B*CAB)/(2*CW2))*ZHiggs(hno, 2))/
       SW)), pG2, 8*i_*Alfa0*Pi, cR1, 2) + replace_(pM1, MW, cG1, 
    addM(-(i_*EL0*SBA*MHiggs2(1)*ZHiggs(hno, 1))/(2*MW*SW), 
     -(i_*CBA*EL0*MHiggs2(2)*ZHiggs(hno, 2))/(2*MW*SW)), pG2, 
    8*i_*Alfa0*Pi, cR1, 2) + replace_(pM1, MASf(All4, 2), cG1, 
    addM(IndexSum(IndexSum(
        (i_*EL0*addM(addM(addM(CB*MW*MZ*SAB*addM(-1, 2*SW2), 2*CW*SA*
                Mf2(2, j1))*IndexDelta(j1, j2)*UASf(All4, j2, 2), 
             CW*addM(SA*Kf(j1, j2, 2), CA*MUEC*IndexDelta(j1, j2)*
     ...
     IndexSum(IndexSum(-(EL0*addM(-(addM(TB*Kf(j1, j2, 2), MUEC*
              ...
              MUE*IndexDelta(j1, j2)*Mf(2, j1))*UASf(All4, j2, 2)*
             UASfC(All4, addM(3, j1), 2)))/(2*MW*SW), j2, 3), j1, 3)*
      ZHiggs(hno, 3)), pG2, 8*i_*Alfa0*Pi, cR1, 2*SumOver(All4, 6)) + 
   replace_(pM1, MASf(All4, bBR), cG1, 
    addM(hgagaSq*IndexSum(IndexSum(
        (i_*EL0*addM(addM(addM(CB*MW*MZ*SAB*addM(-3, 2*SW2), 6*CW*SA*
                Mf2(bBR, j1))*IndexDelta(j1, j2)*UASf(All4, j2, bBR), 
             3*CW*addM(SA*Kf(j1, j2, bBR), CA*MUEC*IndexDelta(j1, j2)*
     ...
     hgagaSq*IndexSum(IndexSum(
      ...
      ZHiggs(hno, 2), hgagaSq*IndexSum(IndexSum(
        -(EL0*addM(-(addM(TB*Kf(j1, j2, bBR), MUEC*IndexDelta(j1, j2)*
              ...
              MUE*IndexDelta(j1, j2)*Mf(bBR, j1))*UASf(All4, j2, bBR)*
             UASfC(All4, addM(3, j1), bBR)))/(2*MW*SW), j2, 3), j1, 3)*
      ZHiggs(hno, 3)), pG2, (8*i_*Alfa0*Pi)/9, cR1, 
    6*SumOver(All4, 6)) + replace_(pM1, MASf(All4, tH), cG1, 
    addM(hgagaSq*IndexSum(IndexSum(
        -(i_*EL0*addM(addM(addM(MW*MZ*SAB*SB*addM(-3, 4*SW2), 
                6*CA*CW*Mf2(tH, j1))*IndexDelta(j1, j2)*UASf(All4, j2, 
                tH), 3*CW*addM(CA*Kf(j1, j2, tH), MUEC*SA*IndexDelta(j1, 
      ...
      ZHiggs(hno, 2), hgagaSq*IndexSum(IndexSum(
        -(EL0*addM(-(addM(Kf(j1, j2, tH), MUEC*TB*IndexDelta(j1, j2)*
               ...
               tH)), addM(KfC(j2, j1, tH), MUE*TB*IndexDelta(j1, j2)*Mf(
                tH, j1))*UASf(All4, j2, tH)*UASfC(All4, addM(3, j1), 
              tH)))/(2*MW*SW*TB), j2, 3), j1, 3)*ZHiggs(hno, 3)), pG2, 
    (32*i_*Alfa0*Pi)/9, cR1, 6*SumOver(All4, 6)));

.sort
drop;

L Result = iT1G1 + iT1G2 + iT1G3 + iT1G4 + iT1G6 + 
  iT1G7 + iT1G8 + iT1G9 + iT2G1 + 2*T1G10 + 2*T1G5 + 
  T2G2 + 2*T3G1 + 2*T4G1;
