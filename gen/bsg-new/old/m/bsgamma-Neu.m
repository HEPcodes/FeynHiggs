((I/108)*MW2*SumOver[All4, 6]*SumOver[Neu4, 4]*
  (SW*Mat[O7[6]]*UASfC[All4, 2, bTR]*(SW*ZNeu[Neu4, 1] - 3*CW*ZNeu[Neu4, 2])*
    (2*(A0[MASf2[All4, bTR]] - A0[MNeu2[Neu4]])*Mf[4, 3]*MNeu[Neu4]*
     ...
     (-2*A0[MASf2[All4, bTR]] + 2*A0[MNeu2[Neu4]] + 
       (1 + 2*C0[Mf2[4, 3], 0, 0, MASf2[All4, bTR], MNeu2[Neu4], 
   ...
   2*SW2*Mat[O7[7]]*UASfC[All4, 5, bTR]*ZNeuC[Neu4, 1]*
