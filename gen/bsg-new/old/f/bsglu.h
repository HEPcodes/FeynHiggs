	...
	LOOP(Gen4, 1,3,1)
     ...
     &               2*C0(Mf2(4,3),0.D0,0.D0,MW2,Mf2(3,Gen4),
	...
	LOOP(Ind1, 1,3,1)
     ...
     &        (tmp2 + (tmp1 - tmp4)/(MASf2(All4,3) - MCha2(Cha4)))*
     &        Mf(4,3)*Mf(bTR,3)*UASf(All4,Ind2,3)*UCha(Cha4,2)*
	...
	LOOP(Neu4, 1,4,1)
     ...
     &    3*CW*Mf(bTR,3)*UASf(All4,3,bTR)*ZNeu(Neu4,3)
        ...
        C8RNeu = C8RNeu + 
     &    1/18.D0*(MW2*SW2*UASfC(All4,5,bTR)*ZNeuC(Neu4,1)*
	...
	LOOP(All4, 1,6,1)
        ...
        C8LGlu = C8LGlu - 
     &    Pi/(3.D0*sqrt2)*(asMW*
     &        ((MGl2*(8*A0(MGl2) - 8*A0(MASf2(All4,bTR))) + 
     &             (8*A0(MASf2(All4,bTR)) + 
     &                16*MGl2*B0(Mf2(4,3),MGl2,MASf2(All4,bTR)))*
     &              MASf2(All4,bTR) - 
     &             8*(A0(MGl2)*MASf2(All4,bTR) + 
     ...
     &                 MASf2(All4,bTR)) + 
     &             C0(Mf2(4,3),0.D0,0.D0,MGl2,MASf2(All4,bTR),MGl2)*
     &              (9*MGl2 - 9*MASf2(All4,bTR))*Mf2(4,3))*
	...
	LOOP(All4, 1,6,1)
     ...
     &                C0(Mf2(4,3),0.D0,0.D0,MGl2,MASf2(All4,bTR),
     &                  MASf2(All4,bTR))*MASf2(All4,bTR)**2)*
     &              Mf2(4,3))*UASf(All4,6,bTR))*UASfC(All4,5,bTR))/
     &      (GF*CKM(3,3)*CKMC(3,2)*(MGl2 - MASf2(All4,bTR))*
     &        Mf2(4,3)**2)
