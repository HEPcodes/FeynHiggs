{(2*asdb*Mino3C*B0q[0, MGl2, MSf2[Sfe3, 4, g1], Qqcd]*Delta[g1, g2]*
    SumOver[Sfe3, 2]*USf[Sfe3, 1, 4, g1]*USfC[Sfe3, 2, 4, g1])/(3*Pi) + 
  (adb*B0q[0, MCha2[Cha3], MSf2[Sfe3, 3, Gen3], Qew]*CKM[Gen3, g1]*
   ...
   (4*Sqrt[2]*MW2*Pi*S2B*SW2) - 
  (AlfaGF*B0q[0, MNeu2[Neu3], MSf2[Sfe3, 4, g1], Qew]*Delta[g1, g2]*
 ...
 ((2*asdb*B1q[0, MGl2, MSf2[Sfe3, 4, g1], Qqcd]*Delta[g1, g2]*
     SumOver[Sfe3, 2]*USf[Sfe3, 1, 4, g1]*USfC[Sfe3, 1, 4, g1])/(3*Pi) + 
   (adb*B1q[0, MCha2[Cha3], MSf2[Sfe3, 3, Gen3], Qew]*CKM[Gen3, g1]*
     ...
     (2*MW*SB*USf[Sfe3, 1, 3, Gen3]*VChaC[Cha3, 1] - 
      Sqrt[2]*Mf[3, Gen3]*USf[Sfe3, 2, 3, Gen3]*VChaC[Cha3, 2]))/
    (16*MW2*Pi*SB2*SW2) + (AlfaGF*B1q[0, MNeu2[Neu3], MSf2[Sfe3, 4, g1], Qew]*
 ...
 ((adb*B1q[0, MCha2[Cha3], MSf2[Sfe3, 3, Gen3], Qew]*CKM[Gen3, g1]*
   ...
   (AlfaGF*B1q[0, MNeu2[Neu3], MSf2[Sfe3, 4, g1], Qew]*Delta[g1, g2]*
