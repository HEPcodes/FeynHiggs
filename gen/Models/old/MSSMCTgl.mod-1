...
IndexRange[ Index[Sfermion] ] = NoUnfold[Range[2]];
...
RenConst[dZHiggs1div[1,1]] := -UVDivergentPart[DSelfEnergy[S[1] -> S[1], 0]];
RenConst[dZHiggs1div[1,2]] := -UVDivergentPart[DSelfEnergy[S[1] -> S[2], 0]];
RenConst[dZHiggs1div[2,2]] := -UVDivergentPart[DSelfEnergy[S[2] -> S[2], 0]];

RenConst[dZH1] := CB2 dZHiggs1div[1,1] + S2B dZHiggs1div[1,2] + SB2 dZHiggs1div[2,2];
RenConst[dZH2] := SB2 dZHiggs1div[1,1] - S2B dZHiggs1div[1,2] + CB2 dZHiggs1div[2,2];
...
RenConst[dZHiggs1gl[1,1]] := dZHiggs1div[1,1];
RenConst[dZHiggs1gl[2,2]] := dZHiggs1div[2,2];
RenConst[dZHiggs1gl[1,2]] := dZHiggs1div[1,2];
