      ...
      (4*SW2*Den[0, 0]*(Finite*MT2 - 6*MT2*(-1/2 - 
         ...
         2*((9*MW2*((-Mq2 - MW2)/2 - (Mq2*(A0[Mq2] - A0[MW2]))/(Mq2 - MW2) + 
           ...
           (MW2*((-Mq2 - MW2)/2 + A0[Mq2] - (MW2*(-A0[Mq2] + A0[MW2]))/(
                -Mq2 + MW2)))/(-Mq2 + MW2) + ((MT2 + 2*MW2)*((-MT2 - MW2)/2 + 
              A0[MT2] - (MW2*(-A0[MT2] + A0[MW2]))/(-MT2 + MW2)))/
            (2*(-MT2 + MW2)) + (-MB2 + MT2 + 2*MW2)*
            (-1/2 + ((-MT2 - MW2)/2 - (MT2*(A0[MT2] - A0[MW2]))/(MT2 - MW2) + 
               A0[MW2])/(2*(MT2 - MW2)) - ((-MT2 - MW2)/2 + A0[MT2] - 
               (MW2*(-A0[MT2] + A0[MW2]))/(-MT2 + MW2))/(2*(-MT2 + MW2)))) + 
         MB2*(-((MW2*((-Mq2 - MW2)/2 - (Mq2*(A0[Mq2] - A0[MW2]))/
                (Mq2 - MW2) + A0[MW2]))/(Mq2 - MW2)) + 
           ((MT2 + 2*MW2)*((-MT2 - MW2)/2 - (MT2*(A0[MT2] - A0[MW2]))/(MT2 - 
                MW2) + A0[MW2]))/(2*(MT2 - MW2)))*Den[MB2, 0]))/MW2)*
