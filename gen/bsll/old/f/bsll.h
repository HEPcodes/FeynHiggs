	...
	LOOP(All5, 1,6,1)
        ...
        CALCha = CALCha + 
     &    1/96.D0*((3 + SW2*(-6 + 4*CW2 + 4*SW2))*CKM(Ind1,3)*
     &        CKMC(Ind2,2)*
     &        (MASf2(All5,3)**2 - 
     &          2*A0(MASf2(All5,3))*
     &           (MASf2(All5,3) - 2*MCha2(Cha5)) - 
     &          MCha2(Cha5)*(2*A0(MCha2(Cha5)) + MCha2(Cha5)))*
     &        (SB2*UASf(All5,Ind1,3)*
     &           (-(sqrt2*(MW*Mf(3,Ind2)*UASfC(All5,3 + Ind2,3)*
     &                  VCha(Cha5,2))) + 
     &             2*MW2*SB*UASfC(All5,Ind2,3)*VCha(Cha5,1))*
     &           VChaC(Cha5,1) - 
     &          Mf(3,Ind1)*UASf(All5,3 + Ind1,3)*
     &           (sqrt2*(MW*SB2*UASfC(All5,Ind2,3)*VCha(Cha5,1)) - 
     &             SB*Mf(3,Ind2)*UASfC(All5,3 + Ind2,3)*
     &              VCha(Cha5,2))*VChaC(Cha5,2)))/
     &      (CW2*MZ2*SB*SB2*CKM(3,3)*CKMC(3,2)*
	...
	LOOP(Ind1, 1,3,1)
     ...
     &        (UASf(All6,Ind3,3)*
     &           (UASfC(All5,Ind3,3) - 4*CW2*UASfC(All5,Ind3,3)) + 
	...
	LOOP(Ind1, 1,3,1)
     ...
     &        UASf(All5,Ind2,3)*
     &        (UASf(All6,Ind1,3)*
     &           (UASfC(All5,Ind1,3) - 4*CW2*UASfC(All5,Ind1,3)) + 
	...
	dup11 = 2*CW*SW2*ZNeuC(Neu6,1) + CW2*SW*ZNeuC(Neu6,2)
     ...
     &            UASf(All5,3,bTR)*
     &           (CB2*MW2*UASfC(All5,2,bTR)*
     &              ((2*dup9*SW2*ZNeuC(Neu5,1)**2 - 
     &                   7*
     &                    (CW*SW2*ZNeu(Neu6,1) - 
     &                      3*CW2*SW*ZNeu(Neu6,2))*ZNeuC(Neu5,1)*
     &                    ZNeuC(Neu5,2) + 
     &                   3*CW2*dup9*ZNeuC(Neu5,2)**2)*ZNeuC(Neu6,1)
     &                  - 3*ZNeuC(Neu5,1)*
     &                 (3*CW2*ZNeu(Neu6,2)*
     &                    (SW*ZNeuC(Neu5,1) - 3*CW*ZNeuC(Neu5,2))-
     &                     ZNeu(Neu6,1)*
	...
	dup16 = 2*CW*SW2*ZNeuC(Neu6,1) + CW2*SW*ZNeuC(Neu6,2)
     ...
     &                UASf(All5,3,bTR)*
     &                 (CB2*MW2*UASfC(All5,2,bTR)*
     &                    ((2*dup12*SW2*ZNeuC(Neu5,1)**2 - 
     &                       5*
     &                       (CW*SW2*ZNeu(Neu6,1) - 
     &                       3*CW2*SW*ZNeu(Neu6,2))*ZNeuC(Neu5,1)*
     &                       ZNeuC(Neu5,2) - 
     &                       3*CW2*dup12*ZNeuC(Neu5,2)**2)*
     &                       ZNeuC(Neu6,1) - 
     &                      ZNeuC(Neu5,1)*
     &                       (3*CW2*ZNeu(Neu6,2)*
     &                       (SW*ZNeuC(Neu5,1) - 
	...
	dup32 = SW2*ZNeuC(Neu6,1) + CW*SW*ZNeuC(Neu6,2)
     ...
     &                USf(Sfe5,1,2,2)*USfC(Sfe5,1,2,2)*
     &                 (dup26*SW2*ZNeuC(Neu5,1)**2 + 
     &                   CW2*
     &                    (-2*
     &                       (SW2*ZNeu(Neu6,1) + 
     &                       CW*SW*ZNeu(Neu6,2))*ZNeuC(Neu5,1)*
     &                       ZNeuC(Neu5,2) - 
     &                      3*dup26*ZNeuC(Neu5,2)**2))) + 
     &             CB2*MW2*UASfC(All5,2,bTR)*
     &              (4*SW2*USf(Sfe5,2,2,2)*USfC(Sfe5,2,2,2)*
     &                 ZNeu(Neu6,1)*
     &                 (dup29*ZNeu(Neu6,1) - 3*dup27*ZNeu(Neu6,2))*
